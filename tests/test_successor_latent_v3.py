"""CUDA numerical contracts for the successor-latent mechanism experiment.
...
from cleanrl.ppo_continuous_action_successor_latent_v3 import (
    ...
    counterfactual_advantages, counterfactual_contexts, projected_coordinate_scores,
