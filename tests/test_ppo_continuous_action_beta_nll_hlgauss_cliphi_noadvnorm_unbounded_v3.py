...
from cleanrl.beta_policy.ppo_continuous_action_beta_nll_hlgauss_cliphi_noadvnorm_unbounded_v3 import (
    Agent,
    Args,
    SAMPLE_EPS,
    beta_nll_to_weights,
...
def test_v3_defaults_combine_requested_ablations_and_hlgauss():
    args = Args()
    assert args.norm_adv is False
    assert args.beta_nll_weight_min == 0.0
    assert args.beta_nll_weight_max == 1e9
