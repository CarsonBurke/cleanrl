...
SCRIPT = (
    ...
    / "cleanrl"
    / "encoder-value"
    / "ppo_continuous_action_lejepa_tddelta_actor16_v4.py"
)
SPEC = importlib.util.spec_from_file_location("lejepa_tddelta_actor16_v4", SCRIPT)
MODULE = importlib.util.module_from_spec(SPEC)
assert SPEC.loader is not None
SPEC.loader.exec_module(MODULE)


def test_actor_credit_horizon_is_16_while_critic_reaches_100():
    args = MODULE.Args()
