"""v12 decay extension 3: weight decay {3, 10} at gate_beta .99999 for the gated families, structured_ood only.
...
plan = {**v12, "suite": [scenario], "families": families, "scenario_families": {"structured_ood": families},
        ...
        "selection": v12["selection"] + " Extension 3: decay {3, 10} at gate_beta .99999 only; compared against the v12 parents.",
        "inherited_from": "benchmarks/plasticity/optimizer_proxy_v12_plan.json"}
Path("benchmarks/plasticity/optimizer_proxy_v12_ext3_plan.json").write_text(json.dumps(plan, indent=1) + "\n")
