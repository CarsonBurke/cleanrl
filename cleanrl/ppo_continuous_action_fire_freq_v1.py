# PPO + FIRE-freq: high-frequency FIRE schedule
#
# Same FIRE mechanism as fire_v1 (Muon-scaled NS-10 + Adam reset) but with
# 7 shocks at every 1M step boundary instead of 3 shocks at [2M, 4M, 6M].
# Hypothesis: more frequent rank recovery → bigger gain over baseline PPO.
import os
import random
import time
