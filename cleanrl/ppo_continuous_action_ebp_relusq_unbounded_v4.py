# PPO + Energy-Based Prediction ReLUSq-unbounded v4.
#
# Clean ablation from v1: keep clipped terminal inference energies and feature-mean
# local Gaussian NLL, but replace each local predictor's tanh-linear mean with a
# ReLU-squared hidden map and linear, unbounded mean output. This isolates whether
# v2/v3 failed because of ReLUSq/unbounded latents or because of the unclipped
# terminal inference energies.
#
