...
"""
**32-step truncated GAE** + env rewnorm + noadvnorm (incr_noadvnorm scale stack).

- num_steps=32, gae_lambda=0.95
- NormalizeReward on; HL-Gauss linear [−20,20]
- norm_adv=False; no d3 retnorm
...
if __name__ == "__main__":
    ...
    print(
        f"IDBD Beta v2 abl_splitac_silu_hlgauss_gae32_noadvnorm: num_steps={args.num_steps} "
