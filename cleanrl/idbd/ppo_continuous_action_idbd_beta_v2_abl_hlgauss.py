...
class Agent(nn.Module):
    """Unimodal Beta actor + HL-Gauss categorical critic."""
...
if __name__ == "__main__":
    ...
    if args.compile:
        ...
        print(f"torch.compile(agent, mode={args.compile_mode!r}) + HL-Gauss critic")
    optimizer = IDBD(
        agent.parameters(),
    ...
    print(
        f"IDBD Beta v2 abl_hlgauss: minibatch_size={args.minibatch_size} "
        ...
        f"HL-Gauss bins={args.num_bins} support=[{args.v_min},{args.v_max}] (norm returns)"
    )
