...
if __name__ == "__main__":
    ...
    print(
        f"IDBD Beta v2 abl_splitac_silu_hlgauss_gae32_raw: num_steps={args.num_steps} "
        ...
        f"HL-Gauss symlog=[{args.v_min},{args.v_max}], SiLU, RAW A (no rewnorm/retnorm/advnorm)"
    )
