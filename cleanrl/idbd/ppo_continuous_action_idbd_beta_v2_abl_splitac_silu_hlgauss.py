...
if __name__ == "__main__":
    ...
    print(
        f"IDBD Beta v2 abl_splitac_silu_hlgauss: minibatch_size={args.minibatch_size} "
        ...
        f"HL-Gauss bins={args.num_bins} support=[{args.v_min},{args.v_max}] (norm returns), SiLU"
    )
