...
class Args:
    ...
    """symlog HL-Gauss without env rewnorm"""
...
if __name__ == "__main__":
    ...
    print(
        f"splitac_silu_hlgauss_delayed_gae32_noadvnorm_norewnorm: DELAYED mature GAE H={H} λ={args.gae_lambda} "
        f"every-step optim on oldest only (n={args.num_envs}), "
        f"meta_lr={args.idbd_meta_lr}, α0={args.learning_rate}, τ={args.target_tau}, NO rewnorm, noadvnorm, HL symlog"
    )
