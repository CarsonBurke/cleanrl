# Predictive-coding actor-critic with Fisher output geometry and TD(lambda), v3.
#
...
# streaming AdamW optimizer. This is prospective predictive coding plus temporal
