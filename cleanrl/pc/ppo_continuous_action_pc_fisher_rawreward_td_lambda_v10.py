# Predictive-coding actor-critic with Fisher output geometry and TD(lambda), raw-reward v10.
#
# Exact fork of clamped TD(lambda) v3 with only two changes: raw MuJoCo rewards
# reach the TD update (no reward normalization/clipping wrappers), and AdamW
# weight decay defaults to zero. All PC inference, Fisher geometry, traces,
# TD normalization/clamping, architecture, initialization, and training remain unchanged.
import math
import os
import random
import time
