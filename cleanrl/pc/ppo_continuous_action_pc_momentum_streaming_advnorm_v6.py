# Predictive-coding actor-critic with momentum dynamics and streaming advantage normalization, v6.
#
...
# exact per-environment, per-parameter TD(lambda) traces and streaming Adam. Two
# actor traces assign each score a lagged lambda-return mean and scale, reproducing
# normalized forward TD(lambda) credit without a rollout or current-sample leakage.
# This is prospective predictive coding plus temporal eligibility, not backprop.
import math
import os
import random
import time
    ...
    for update in range(1, args.num_updates + 1):
        ...
        if collect_diagnostics:
            ...
            print(
                ...
                f"adv_std={float(assigned_advantage_std):.3f}, "
