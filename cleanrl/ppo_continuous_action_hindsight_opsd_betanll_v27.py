...
#
# OPSD v27: learned full-batch signed actor-gradient matching distribution.
#
# v27 note: v25 learned quickly, but its ReLU-positive target still hand-shapes the
# distribution. v27 trains the full-minibatch nonnegative weighter to align the
# weighted-MLE actor gradient with the signed advantage policy-gradient target.
# The learned distribution must discover which samples best approximate that signed
# improvement direction under the student's Beta actor geometry; no fixed top-k or
# exp-advantage rule is used for the actual actor update.
#
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                target_loss = -(mb_advantages.detach() * match_logprob).mean()
