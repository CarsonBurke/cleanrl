# PPO + IterThink v24.7 (NARROW FULL-COVARIANCE TANH NORMAL). From v24.6.
#
...
#
# v24.7 keeps v24.6's state-dependent full-covariance tanh Normal, but uses a
# narrower initial latent scale. v24.6's identity-covariance init was too broad
# for PPO on HalfCheetah and was still negative at 560k steps. Starting around
# std=0.5 preserves coordinated exploration without drowning early gait discovery.
#
...
class Args:
    ...
    # v24.7: action distribution. "fullcov" (state-dependent full-cov tanh Normal)
...
class Agent(nn.Module):
    def __init__(self, envs, args):
        ...
        # v24.7: narrow full-covariance tanh Normal default, with v24 beta/diagonal controls.
    ...
    def _actor_dist(self, actor_feat):
        ...
        if self.actor_dist == "fullcov":
            ...
            raw_offdiag = self.actor_tril_head(actor_feat)
    ...
    def actor_parameters(self):
        ...
        if self.actor_dist == "gaussian":
            ...
            heads = (
                ...
                + list(self.actor_logstd_head.parameters())
                + list(self.actor_tril_head.parameters())
            )
        else:
