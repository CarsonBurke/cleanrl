# PPO + IterThink v144 v129-noobsnorm-k6 (v129 without env obs norm/clip).
#
# Key change from v129:
#   - Remove Gym's stateful NormalizeObservation and normalized-observation clip
#     transform. Everything else is v129: symmetric reward/critic supports,
#     rolling k=6 prompt bank, and per-feature affine observation tokens.
#
# Hypothesis:
#   This isolates whether v129's advantage came from the prompt-bank/per-feature
#   affine tokenization path or from the env observation normalizer.
#
# -----------------------------------------------------------------------------
# Previous header:
