...
def main():
    ...
    try:
        ...
        writer.add_text("policy", "Beta: alpha,beta=1+softplus(head); least-squares fit of log-ratio + KL(pi_old||pi) to z(A) / eta")
        ...
        def prepare_targets(advantages):
            """The batch-wide log-ratio target z(A) / eta, fixed for every epoch of this rollout."""
