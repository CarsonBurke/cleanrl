# PPO control for the AWR family: residual SiTU-GLU v7 with separate actor/critic clipping.
# Identical to ppo_continuous_action_residual_stiglu_ngpt_scaled_asymclip_v7.py
# except that each network is clipped to its own max_grad_norm budget, matching
# awr_ce_tpo_sepclip_v4 so that the clip change is not credited to the AWR target.
