...
v19: Add standard entropy bonus (ent_coef=0.01) to prevent noise collapse.
v6 had ent_coef=0 with detached entropy — no gradient pressure to maintain
exploration. L matrix diagonal collapses from ~1.0 to ~0.24, causing Hopper/Walker
to fail. This minimal change adds the standard PPO entropy bonus.
"""
import os
import random
import time
