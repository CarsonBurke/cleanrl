"""PPO Transformer with Deeper Critic (v10)

Same as v6 (~6005 on HalfCheetah) but with a 2-block critic instead of 1.
Hypothesis: matching critic depth to actor depth gives better value estimates,
which improves advantage computation and policy updates.

Architecture changes from v6:
  - Critic: 1 transformer block → 2 transformer blocks
...
class Agent(nn.Module):
    def __init__(self, envs, args):
        ...
        # === Critic backbone (separate, 2 blocks to match actor depth) ===
        ...
        self.critic_transformer1 = TransformerBlock(d_token=d_token, n_heads=4, ffn_hidden=hidden_dim)
        self.critic_transformer2 = TransformerBlock(d_token=d_token, n_heads=4, ffn_hidden=hidden_dim)
    ...
    def _critic_features(self, x):
        ...
        tokens = self.critic_transformer1(tokens)
        tokens = self.critic_transformer2(tokens)
