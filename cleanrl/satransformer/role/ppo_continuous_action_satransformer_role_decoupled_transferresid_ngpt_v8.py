# nGPT hypersphere satransformer transferresid v8.
#
# Variant from:
#   HalfCheetah-v4__satransformer_role_decoupled_ngpt_v7_hc8m__1__1781056100
#
# Only intended algorithmic difference vs v7: learned same-index transfer
# residuals are added to transformer FFN residual branches from preceding
# same-shape stream states. Critic, reward normalization, actor/critic heads,
# action distribution, and PPO learner settings remain v7.
#
# nGPT hypersphere satransformer v7: decoupled role-token encoder/decoders
# with the iterthink learner stack.
#
