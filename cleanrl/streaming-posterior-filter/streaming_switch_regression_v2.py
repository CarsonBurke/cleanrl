# Rigorous fully streaming benchmark for the Streaming Posterior Filter family.
# Predict -> score -> update exactly once per temporally ordered sample.
# The robust filter is an assumed-density diagonal posterior, not an exact
# Student-t posterior: dense observations induce covariance that is discarded.
...
def main():
    ...
    run_name = (
        f"StreamingSwitch-v1__{args.exp_name}_{args.method}_{args.condition}"
