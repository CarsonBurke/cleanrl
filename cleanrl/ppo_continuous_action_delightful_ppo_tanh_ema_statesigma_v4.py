# Delightful PPO with return-calibrated DG and standard-rollout actor updates v4.
#
...
#
# Hypothesis: order-one return scale will keep delight responsive rather than
