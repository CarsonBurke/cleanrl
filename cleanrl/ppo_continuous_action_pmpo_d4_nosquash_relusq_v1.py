# PMPO-D4 NoSquash + ReluSq v1: dreamer4-aligned PMPO (no tanh action squash)
# combined with relu(x)^2 hidden activations. Removing the squash makes
# latent KL == action KL, so unbounded hidden activations no longer decouple
# the reverse_KL trust region from the actual policy distribution. This is
# the principled way to use unbounded hidden activations under PMPO.
