# Critic readout-coordinate and variance-multiplier ablations of PPO v20.
# Keep raw K101/sigma0.5 mean-matched targets, both SiTU trunks and matrix projection.
# Compare clipping only the critic gain, plain CE, and gamma=0.01*u with u=1.
# Relative coordinates preserve initial logits while changing Adam's physical step units.
# Hypothesis: calibrate critic optimization without globally suppressing actor updates.
# Exact Beta KL is diagnostic only; no KL caps, value gates or gain EMA.
import math
import os
import random
import time
