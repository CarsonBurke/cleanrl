# PPO + IterThink v24 beta d4-HL-Gauss symlog + Dynamic Sparse Recurrent Graph (DSRG) v3.
#
...
class Args:
    ...
    route_grad_clip: float = 0.5     # max-norm for the DECOUPLED route-structural gradient (routing params only)
