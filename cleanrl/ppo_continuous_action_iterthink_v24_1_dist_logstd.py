# PPO + IterThink v24.1 (BETA DEFAULT + SAC-CORRECT GAUSSIAN LOG-STD). From v24.
#
# v24.1 keeps v24's action-distribution toggle and beta default, but corrects the
# Gaussian control path to use SAC's state-dependent log_std parameterization instead
# of v24's log-variance head. This makes the tanh-Gaussian branch match SAC continuous
# action's scale semantics:
...
# gaussian path differs from v24 only in the scale head: log-variance -> log_std.
...
class Args:
    ...
    # v24.1: action distribution. "beta" (unimodal, dreamer4 default) | "gaussian"
...
class Agent(nn.Module):
    def __init__(self, envs, args):
        ...
        # v24.1: beta default plus SAC-style tanh-Gaussian log_std control path.
