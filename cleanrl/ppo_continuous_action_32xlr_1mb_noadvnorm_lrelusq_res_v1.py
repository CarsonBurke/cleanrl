...
# Hidden trunk is residual LeakyReluSq: res_v1 scaffolding with LeakyReluSq
# pairs (0.5-matched) instead of SiTU branches. See lrelusq_res_v1 header.
import os
import random
import time
...
def main():
    ...
    try:
        ...
        writer.add_text("policy", "Beta host actor; 32x LR; 1 minibatch; residual LeakyReluSq trunk; no advantage normalization")
