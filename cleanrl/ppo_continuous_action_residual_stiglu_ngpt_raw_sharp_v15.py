# Sharp, raw-mean-preserving symlog categorical critic v15.
# Preserve v13 PPO, architecture, raw rewards and fixed +/-20000 support.
# Scale the KL-tilt bracket by raw-node spacing and use 48 bisections: sharp
# labels between sparse nodes can require a dual coefficient outside +/-1.
# Additional precision keeps the wider bracket accurate on large raw values.
# Default: K101, sigma 0.25 bins; no advnorm, value clip, target frame or EMA.
import math
import os
import random
import time
...
def make_target_projector(args, histogram):
    ...
    return partial(gaussian.project_moment_matched,
                   tilt_bound=64.0 / gaussian.bin_width, iterations=48)
