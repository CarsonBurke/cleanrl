# PPO + ReLUSq + Beta action distribution v1
#
# Hypothesis:
# v115's bounded Beta actor may be a better MuJoCo action distribution than
# Gaussian/gSDE when isolated in a plain PPO loop. This variant keeps CleanRL PPO
# intact and uses a ReLUSq MLP actor that predicts Beta concentration parameters
# with alpha,beta = 1 + softplus(head), then maps z in (0, 1) to the env action
# range.
#
# Novelty in this repo:
# - minimal v115-style Beta actor ablation against the gSDE variants
