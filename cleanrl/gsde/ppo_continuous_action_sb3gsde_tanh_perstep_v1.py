# PPO + SB3-style gSDE per-step resampling + Tanh MLP v1
#
# Hypothesis:
...
# - Tanh hidden activations with optional expln() std transform
...
class Agent(nn.Module):
    ...
    def get_action_and_value(self, x, action=None):
        ...
        if action is None:
            ...
            action = self.action_dist.sample(action_mean, latent_sde).detach()
