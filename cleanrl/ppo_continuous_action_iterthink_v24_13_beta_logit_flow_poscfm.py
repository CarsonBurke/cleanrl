# PPO + IterThink v24.13 (BETA LOGIT ACTION FLOW, POSITIVE-ONLY CFM). From v24.9.
#
# Isolated ablation: keep v24.9's flow, replay, and joint PPO/CFM clipping, but
# make the CFM auxiliary imitate only positive-advantage samples. v24.9 used
# `1 + relu(adv)`, which still trained the flow toward neutral/bad actions.
#
