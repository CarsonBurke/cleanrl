"""PPO with Trading-Bot-Inspired Architecture (tbot_tight_nonorm)

Based on tbot_tight but WITHOUT RMSNorm on SDE features.
...
2. **No SDE normalization**: Unlike tbot_tight, sde_fc output feeds directly
   into soft-sign bounding without RMSNorm.
