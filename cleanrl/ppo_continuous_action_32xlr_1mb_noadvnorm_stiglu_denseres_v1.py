...
# Hidden trunk is dense-residual SiTU-GLU: three SiTU blocks, every previous
# stream gated into every later stage with learned per-channel gates (init
# ~0.18, no normalization). See stiglu_denseres_v1 header.
import os
import random
import time
...
def main():
    ...
    try:
        ...
        writer.add_text("policy", "Beta host actor; 32x LR; 1 minibatch; dense per-channel-gated SiTU-GLU trunk; no advantage normalization")
