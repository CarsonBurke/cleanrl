# PPO + IterThink v176.1 beliefonly-jointsigreg-pretemporalwm-ppoadvnorm-actor1-critic10-cliphi-criticsigma075-dreamer3bucket-hlgauss-wmloss1024-cudagraph-contdisc-k6.
#
# v176.1 = v176 but with a BELIEF-ONLY agent input (obs_cond_mode="none"), reverting the
