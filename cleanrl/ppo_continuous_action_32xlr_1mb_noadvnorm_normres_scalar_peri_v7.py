# Peri-RMS scalar PPO, v7: matched v6 noclip reference.
# Normalize branch inputs and outputs before gated residual addition in both networks.
# Preserve reward normalization, clipped scalar value loss, final RMS and Adam;
# gradient clipping defaults off, exactly as ppo_scalar_clip_toggle_v6_noclip_50M.
# Fixed output-norm gain, optional embedding norm omitted (Peri-LN section 5.3).
# Hypothesis: control branch amplitude drift without constraining the identity path.
import os
import random
import time
