# PPO + IterThink v62 (v24 Beta + recurrent latent tokens + hot Xavier PMA reads). From v24.
#
...
#   - v62 removes the conservative transformer damping from v56/v61: attention
#     residual scales, FFN residual scales, q-gain, and output projections start at
#     1.0, with trunk/transformer weights initialized by Xavier instead of
#     orthogonal scaling.
#
