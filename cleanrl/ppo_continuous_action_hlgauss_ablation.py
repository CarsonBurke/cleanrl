# Ablation: base PPO with symlog HL-Gauss categorical value head.
# SiLU + RMSNorm critic architecture (DreamerV3/4-style).
# Purpose: isolate the effect of symlog HL-Gauss vs MSE scalar critic.
import os
import random
import time
