# PPO + Beta-NLL clip-hi no-advnorm unbounded-weights HL-Gauss critic v3.
#
...
# actions. HL-Gauss value labels should improve critic gradients by preserving
# target locality over the actual normalized return range.
import os
import random
import time
...
if __name__ == "__main__":
    ...
    if not args.cuda or not torch.cuda.is_available():
        raise RuntimeError("ppo_continuous_action_beta_nll_hlgauss_cliphi_noadvnorm_unbounded_v3 requires CUDA")
