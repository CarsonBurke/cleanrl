# IterThink v24 beta d4-HL-Gauss symlog critic + FULL-ALIGNED replay Delightful PG v5.
#
# WHY v5. dg_paper_v1 copied Algorithm 2's actor loss but fed it ON-POLICY
...
class Args:
    ...
    replay_size: int = 1_048_576      # transitions (paper 2e6 over 10M steps; we run 8M)
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                with torch.no_grad():
                    ...
                    td_adv = r_rew[ridx] + args.gamma * v_sp * r_nonterm[ridx] - v_s
                ...
                if args.delightful_pg:
                    ...
                    with torch.no_grad():
                        ...
                        td_adv_means.append(td_adv.mean().item())
                        td_adv_stds.append(td_adv.std(unbiased=False).item())
                else:
