# PPO + IterThink v68 (v56 + per-dim late Beta entropy floor). From v24.
#
...
#   - v68 keeps the v56 architecture unchanged. The 8M v56 rerun learns faster
#     than v24 but over-sharpens late (entropy ~-11.6, concentration ~50), causing
#     final variance/regression. Add a weak Beta-only per-action-dim entropy floor
#     that is inactive until the policy becomes more deterministic than the v24/v63
#     final regime.
#
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                if args.separate_grad_clip:
                    ...
                    optimizer.zero_grad(set_to_none=True)
                    (pg_loss - ent_coef_eff * entropy_loss + beta_entropy_floor_loss).backward()
                    ...
                    loss = pg_loss - ent_coef_eff * entropy_loss + beta_entropy_floor_loss + v_loss * args.vf_coef
                    optimizer.zero_grad()
                    loss.backward()
