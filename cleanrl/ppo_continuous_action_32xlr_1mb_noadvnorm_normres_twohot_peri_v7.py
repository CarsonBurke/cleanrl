# Peri-RMS SiTU-GLU PPO, v7: normalize branch inputs and outputs.
# Matched v4 raw d3range two-hot reference; only normalization placement changes.
# h += sigmoid(g) * RMS(B(RMS(h))); retain final RMS and 1/sqrt(width) readout.
# Fixed output-norm gain follows Peri-LN section 5.3; optional embedding norm omitted.
# Hypothesis: control branch amplitude drift while preserving the identity path.
import os
import random
import time
