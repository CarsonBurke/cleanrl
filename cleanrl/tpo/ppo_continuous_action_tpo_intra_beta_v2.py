# Intra-trajectory Target Policy Optimization (TPO) with a Beta action policy. v2.
#
...
#  3. Honest diagnostics. Residual/movefrac are averaged over whole epochs rather
