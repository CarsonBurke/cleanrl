# PPO + Energy-Based Prediction Full-BPC v1.5.
#
...
class Args:
    ...
    """absolute clamp for the second inferred hidden state; defaults to pc_state_clip"""
...
class PCHierarchy(nn.Module):
    ...
    def initial_states(self, x, args):
        ...
        h1_mean = clip_state_value(h1_mean, state_clip_for_layer(args, 0))
        h2_mean, _ = self.edge1(h1_mean, args.pc_logvar_min, args.pc_logvar_max)
        h2_mean = clip_state_value(h2_mean, state_clip_for_layer(args, 1))
