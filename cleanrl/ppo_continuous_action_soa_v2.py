# SOA v2: Gated Spectral Observation Augmentation for PPO
#
# Key changes from v1:
# - Increased hidden dimension to 256.
# - Added a state-dependent gate for the skip connection.
# - The gate allows the agent to selectively use or ignore the spectral features
#   based on the current state (e.g., ignoring noise in simple states).
# - Added full logging for losses and SPS.
