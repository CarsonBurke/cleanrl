# PPO + IterThink v24 beta d4-HL-Gauss symlog critic + TAIL-ONLY entropy-referenced Delightful gate v2.
#
...
class Args:
    ...
    # Tail-only entropy-referenced Delightful gate (continuous-corrected arXiv:2603.14608v1).
