# PPO + objective-projected future-reward predictive-state critic, v2 (RNG-paired).
#
...
# correlated sequence errors that coordinatewise MSE cannot see, while exact scalar
# TD0 trains the composed value. PPO uses true environment-reward GAE. Reward norm is off.
import os
import random
import time
