# Native direct policy gradient with correct time-limit bootstrapping v12.
#
# Keeps v11's raw native-reward policy update and exact-KL trust-region
# ablations, while separating true terminations from time-limit truncations.
# Truncations bootstrap from Gymnasium's final observation but still cut the
# GAE trace, preventing reset leakage and horizon-scale critic target spikes.
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for _ in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                critic_loss = 0.5 * nn.functional.mse_loss(newvalue, b_returns[mb_inds])
