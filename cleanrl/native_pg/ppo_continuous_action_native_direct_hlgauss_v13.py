# Native direct policy gradient with a symlog HL-Gauss critic v13.
#
# Replaces raw-return MSE with a neutral-initialized categorical critic over
# symlog-spaced raw returns. Six boundary-masked future-return heads provide
# auxiliary temporal prediction; expected raw values still drive unchanged GAE.
# Hypothesis: scale-aware classification prevents critic fit from degrading as
# HalfCheetah's reward and value scales grow, without changing the PPO objective.
