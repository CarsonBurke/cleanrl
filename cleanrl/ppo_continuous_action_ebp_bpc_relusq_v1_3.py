# PPO + Energy-Based Prediction BPC-ReLUSq v1.3.
#
...
#
# v1.3 keeps v1.2's dense local Gaussian predictors but changes the hidden
# predictor feature activation from tanh(h) to ReLU(h)^2. The first predictor
# still uses normalized observations directly. This tests whether ReLUSq's
# stronger positive quadratic feature basis helps BPC-style local prediction.
#
...
class Args:
    ...
    pc_hidden_activation: str = "relusq"
