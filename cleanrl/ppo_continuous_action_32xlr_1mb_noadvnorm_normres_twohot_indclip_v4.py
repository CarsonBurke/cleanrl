# Independent actor/critic gradient clipping on pre-RMS SiTU-GLU PPO.
# Frozen reference: normres_dreamer_twohot_v3; identical trunks and zero bin head.
# Each network has its own 0.5 norm budget; joint Adam moments remain per parameter.
# Optional reward normalization; no return-target norm, value clipping, or critic EMA.
