# PPO + IterThink v71 (v24 Beta + compact LeWM backbone). From v24.
#
...
# embeddings, optimized by masked MSE against detached targets. PPO never reads
# backprops through the WM; the v24 agent trunk reads detached WM latents. This
# tests the requested "WM latent -> v24 agent" composition while preserving the
# proven v24 ThinkTrunk as the policy/value backend.
#
# --- inherited v24 notes ---
#
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            with torch.no_grad():
                agent_input = agent.agent_input_from_obs(next_obs)
