# PPO + IterThink v96 (v24 Beta + root-action TPO with branch-return scores). From v95.
#
...
# rollout policy at each state. Unlike v94's myopic immediate-reward score, v96
...
# v95's tail-likelihood credit assignment error.
#
# --- inherited v24 notes ---
...
class Args:
    ...
    # v96: pure TPO actor objective over root actions, scored by short branches.
...
if __name__ == "__main__":
    ...
    assert args.env_id == "HalfCheetah-v4", "v96 counterfactual probing is HalfCheetah-v4-specific"
