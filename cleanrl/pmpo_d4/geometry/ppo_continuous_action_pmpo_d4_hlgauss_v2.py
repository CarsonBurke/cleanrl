# PMPO-D4 with an HL-Gauss critic for continuous-action PPO.
#
# Hypothesis: keep the PMPO actor from v1, but replace scalar value regression
# with a distributional HL-Gauss value head. The critic predicts categorical
# logits over symlog value bins; GAE uses the expected scalar value, while value
# training uses cross-entropy against Gaussian-projected returns.
