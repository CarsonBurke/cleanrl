# PMPO-D4 + ReluSq hidden activation v1.
#
# Identical to pmpo_d4_v1 except all hidden Tanh in the actor and critic MLPs
# are replaced with f(x) = relu(x)^2 (= x^2 for x>=0, 0 otherwise). Action-squash
# tanh is unchanged. No advantage normalization (PMPO's natural setting).
