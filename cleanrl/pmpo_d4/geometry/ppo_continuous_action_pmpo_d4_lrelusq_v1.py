# PMPO-D4 + LeakyReluSq hidden activation v1.
#
# Identical to pmpo_d4_v1 except all hidden Tanh in the actor and critic MLPs
# are replaced with f(x) = (0.5*x + 0.5*relu(x))^2. Action-squash tanh is
# unchanged. No advantage normalization (PMPO's natural setting). Tests the
# activation swap on the unmodified PMPO objective.
