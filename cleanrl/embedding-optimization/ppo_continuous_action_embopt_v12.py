# Embedding Optimization v12 (embopt_v12) — family: cleanrl/embedding-optimization/ (see FAMILY.md)
#
...
if __name__ == "__main__":
    ...
    def critic_loss_fn(z, g, target):
        ...
        main = nn.functional.smooth_l1_loss(d, d_target)
    ...
    if args.compile:
        ...
        print(f"[embopt_v12] torch.compile(mode={args.compile_mode!r}, dynamic=False)")
