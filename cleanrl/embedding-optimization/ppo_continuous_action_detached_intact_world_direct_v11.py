# Detached INTACT World Direct v11
#
...
# forward-objective token and that same law are trained through a frozen world
...
def combined_controller_objective(agent, factual_z, previous_action, action_chunk, args):
...
if __name__ == "__main__":
    ...
    assert args.latent_dim == 64, "detached INTACT World Direct v11 uses 64-D latents"
    ...
    if args.compile:
        ...
        print(
            "[detached_intact_world_direct_v11] "
