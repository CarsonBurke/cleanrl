# Embedding Optimization v28_fixg (embopt_v28_fixg) — family: cleanrl/embedding-optimization/ (see FAMILY.md)
#
...
if __name__ == "__main__":
    ...
    if args.compile:
        ...
        print(f"[embopt_v28_fixg] torch.compile(mode={args.compile_mode!r}, dynamic=False)")
