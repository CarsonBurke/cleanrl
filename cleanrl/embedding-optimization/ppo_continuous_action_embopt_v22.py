# Embedding Optimization v22 (embopt_v22) — family: cleanrl/embedding-optimization/ (see FAMILY.md)
#
...
if __name__ == "__main__":
    ...
    if args.compile:
        ...
        print(f"[embopt_v22] torch.compile(mode={args.compile_mode!r}, dynamic=False)")
