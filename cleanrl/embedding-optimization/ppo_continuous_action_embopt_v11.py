# Embedding Optimization v11 (embopt_v11) — family: cleanrl/embedding-optimization/ (see FAMILY.md)
#
...
if __name__ == "__main__":
    ...
    def policy_loss_fn(z, g):
        # the original family objective: one differentiable scalar, one model step
        a = agent.act(z, g)
        r = agent.rhat(z, a)
    ...
    if args.compile:
        ...
        print(f"[embopt_v11] torch.compile(mode={args.compile_mode!r}, dynamic=False)")
