# Embedding Optimization v9 (embopt_v9) — family: cleanrl/embedding-optimization/ (see FAMILY.md)
#
...
if __name__ == "__main__":
    ...
    if args.compile:
        ...
        print(f"[embopt_v9] torch.compile(mode={args.compile_mode!r}, dynamic=False)")
