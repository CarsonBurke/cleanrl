...
# interval velocity from (z_t, a_t). Deterministic projected Adam optimizes three
# predicted rewards through the latent dynamics, without a terminal value. The
# hypothesis is that H3 captures short locomotion synergies while avoiding the
...
if __name__ == "__main__":
    ...
    assert args.latent_dim == 64, "INTACT velocity H3 v3 uses 64-D latents"
