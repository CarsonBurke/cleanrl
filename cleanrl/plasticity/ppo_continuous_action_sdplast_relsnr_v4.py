...
#   lam == 1 exactly while each unit's SNR EMA fills; afterwards the reference is
#   the layer's OWN CROSS-UNIT MEAN at the current step, in log space.
...
#   reference is the live cross-unit log mean, so the level cannot drift
