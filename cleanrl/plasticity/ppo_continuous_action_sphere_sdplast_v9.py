...
from cleanrl.shared.host_actor import (
    HostSiTUSphereActor, justnorm, make_situ_sphere_trunk, situ_glu,
)
...
class PlasticityStepper:
    ...
    def levels(self):
        ...
        for layer in self.layers:
            ...
            level = self.args.snr_exponent * layer.snr.clamp_min(1e-30).log()
            level = level - level.mean()
            bounded = torch.tanh(self.args.lam_gain * level / span)
