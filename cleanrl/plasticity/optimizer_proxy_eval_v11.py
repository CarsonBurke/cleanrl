"""v11 protocol: the v10 protocol driving optimizer_proxy_model_v11 (adds polar_svag / rms_svag), named
OptimizerProxy__v11_*, plus one new regime kind. A scenario carrying `relevant` uses structured teachers
...
from cleanrl.plasticity import optimizer_proxy_model_v11 as optimizer
...
class Args:
    ...
    test: int = 8192
    output: str = ""
    plan: str = "benchmarks/plasticity/optimizer_proxy_v11_plan.json"
...
def main():
    ...
    root = Path(args.output or f"runs/OptimizerProxy__v11_{args.scenario}{tag}__{args.seed}__{time.time_ns()}")
    ...
    sources = [Path(__file__), Path(optimizer.__file__), Path(optimizer.base.__file__),
               ...
               Path(optimizer.base.base.base.base.__file__), Path(optimizer.base.base.base.base.base.__file__),
               Path(optimizer.base.base.base.base.base.base.__file__), Path(model.__file__), Path(reference.__file__),
