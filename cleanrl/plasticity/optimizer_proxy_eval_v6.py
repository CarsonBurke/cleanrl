...
class Args:
    ...
    test: int = 8192
    output: str = ""
    plan: str = "benchmarks/plasticity/optimizer_proxy_v6_plan.json"
...
def main():
    ...
    root = Path(args.output or f"runs/OptimizerProxy__v6_{args.scenario}__{args.seed}__{time.time_ns()}")
