...
# p is tanh-capped to +-log(weight_max), so it cannot represent an ABSOLUTE log
...
# [-2*p_cap, 2*p_cap], which is exactly the pre-existing
# [1/weight_max^2, weight_max^2] envelope. At init every gate parameter is zero,
