...
class Agent(nn.Module):
    ...
    def _make_backbone(self, obs_dim):
        """Create one transformer backbone: (embed_w, embed_b, embed_norm, layers, final_norm, cls_token)."""
        ...
        return embed_w, embed_b, embed_norm, layers, final_norm, cls_token

    def _forward_backbone(self, x, embed_w, embed_b, embed_norm, layers, final_norm, cls_token, attn_gate=1.0):
