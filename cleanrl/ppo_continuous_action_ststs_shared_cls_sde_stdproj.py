...
# - direct std projection from SDE CLS: action_std = exp(std_proj(sde_cls))
import os
import random
import time
...
class Agent(nn.Module):
    ...
    def _get_action_std(self, sde_latent):
        return torch.exp(self.std_proj(sde_latent))
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        with torch.no_grad():
            ...
            writer.add_scalar("sde/std_weight_std", agent.std_proj.weight.std().item(), global_step)
