# HL-Gauss Value Head + Direct Log-Std (Dreamer4-style) for PPO
...
# discretized value bins, plus state-dependent exploration noise.
#
...
#   - Actor outputs (mean, log_std) per observation — state-dependent noise
