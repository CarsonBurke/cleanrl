# HL-Gauss + Direct Log-Std + DG with Std-Normalized Value-Loss Surprisal
#
# Divides delight by its minibatch std (no mean shift). Preserves sign
# and asymmetry while putting 95% of values in [-2, 2] sigmoid range.
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                with torch.no_grad():
                    ...
                    # Divide by std only (no mean shift) — preserves sign asymmetry
                    dg_weight = torch.sigmoid(delight / (delight.std() + 1e-8))
