# Fork of hlgauss_silu_sig05: symlog HL-Gauss categorical value head,
# SiLU + RMSNorm critic (DreamerV3/4-style). Adds direct log-std:
# actor predicts log_std from a shared trunk instead of using a free
# Parameter, so exploration scale becomes state-dependent.
import os
import random
import time
...
class Agent(nn.Module):
    def __init__(self, envs, num_bins):
        ...
        # Critic: SiLU + RMSNorm -> num_bins logits (DreamerV3/4-style)
