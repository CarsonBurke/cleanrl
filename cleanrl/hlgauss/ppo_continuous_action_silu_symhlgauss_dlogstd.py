# Dreamer4-style RMSNorm+SiLU + SymLog HL-Gauss (no vclip) + Direct Log-Std
# Targets are symlog-transformed before HL-Gauss projection, predictions are
# symexp-transformed after extraction. This compresses the value range and
# gives uniform resolution across magnitudes.
import os
import random
import time
