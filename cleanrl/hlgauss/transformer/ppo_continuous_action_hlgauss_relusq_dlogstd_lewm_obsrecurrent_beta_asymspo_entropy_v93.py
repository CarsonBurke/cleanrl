...
# - v93: keeps v89 architecture but restores D4-style nonzero policy entropy on
#   both real and imagined Beta actor updates to counter actor-std collapse
import os
import random
import sys
import time
...
class Args:
    ...
    imagine_actor_ent_coef: float = 0.01
