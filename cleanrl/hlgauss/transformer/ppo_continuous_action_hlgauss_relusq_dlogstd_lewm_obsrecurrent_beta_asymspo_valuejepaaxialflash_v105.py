...
class AxialAdaLNTransformerBlock(nn.Module):
    ...
    def forward(self, x, step_action_features, rope_cos, rope_sin):
        ...
        return self._from_axis(x_axis, batch, time, space, width)
        ...
        with torch.no_grad():
            for _ in range(args.imagine_horizon):
                ...
                if predictor_cache is None:
                    ...
                    for cache_idx in range(context_len):
                        (
                            pred_next_summary,
                            pred_value_token,
                            pred_reward_logits,
                            ...
                            pred_context[:, cache_idx],
                            action_context[:, cache_idx],
                            predictor_cache,
