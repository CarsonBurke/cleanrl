...
#
# This variant tests the direct LeWM/stable-worldmodel control loop first:
...
class Args:
    ...
    """if toggled with planner_execute, train the actor toward logged planner behavior actions instead of rerunning the inner solver"""
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            if planner_active:
                ...
                planner_init_seq = action.detach().unsqueeze(1).expand(
                    -1,
                    args.inner_solver_horizon,
                    -1,
                ).contiguous()
