...
if __name__ == "__main__":
    ...
    def run_inner_action_solver(start_summary, init_actions):
        ...
        init_actions: (B, H, A) initial actions inside the action box.
        ...
        try:
            ...
            init_norm = ((init_actions.detach() - action_mid) / action_scale).clamp(
                -1.0 + SAMPLE_EPS,
                1.0 - SAMPLE_EPS,
            )
        ...
        return final_action.detach(), initial_cost, final_cost
