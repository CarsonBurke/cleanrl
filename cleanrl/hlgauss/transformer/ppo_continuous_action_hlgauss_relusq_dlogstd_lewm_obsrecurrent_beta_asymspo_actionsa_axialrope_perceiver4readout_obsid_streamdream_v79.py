...
#   WM training still starts from neutral current summaries and skips current-slot
#   SIGReg; outcome labels are only target/future summary content.
import os
import random
import sys
import time
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for epoch in range(args.wm_update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                # Current summaries have neutral outcome placeholders; regularize
                # only future target summaries whose outcome tokens are real labels.
                sigreg_valids = [torch.zeros(mb_size, device=device, dtype=torch.bool)]
