...
# - PMPO actor loss with raw-sign advantages inside PPO's clipped ratio objective
...
class Args:
    ...
    norm_adv: bool = False
    """Toggles advantages normalization (disabled by default for PMPO sign splits)"""
    clip_coef: float = 0.2
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                # PMPO policy loss: keep PPO ratios/clipping, replace advantage magnitude with sign only.
