...
# - v100: enforces parity between closed-loop dynamics training horizon and imagined PPO
#   horizon, avoiding actor/critic updates on untrained autoregressive tail steps.
import os
import random
import sys
import time
...
class Args:
    ...
    """dream rollout horizon for Dreamer-style imagined GAE; v100 keeps this equal to dyn_horizon"""
...
if __name__ == "__main__":
    ...
    if args.imagine_horizon != args.dyn_horizon:
        raise ValueError("--imagine-horizon must equal --dyn-horizon in v100 horizon-parity experiments")
