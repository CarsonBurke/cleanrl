...
# - v50: collect 4096 steps per env and use 16 larger WM minibatches per rollout
import os
import random
import sys
import time
...
class Args:
    ...
    wm_num_minibatches: int = 16
    """number of larger world-model minibatches per rollout"""
    ...
    wm_minibatch_size: int = 0
    """the world-model mini-batch size (computed in runtime)"""
...
if __name__ == "__main__":
    ...
    args.wm_minibatch_size = int(args.batch_size // args.wm_num_minibatches)
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for epoch in range(args.wm_update_epochs):
            ...
            for start in range(0, args.batch_size, args.wm_minibatch_size):
                end = start + args.wm_minibatch_size
