...
class Agent(nn.Module):
    def __init__(
        ...
        self.critic = ReluSqRMSHead(AGENT_INPUT_DIM, 64, num_bins, output_std=1.0)
        self.actor_mean = ReluSqRMSHead(AGENT_INPUT_DIM, 64, act_dim, output_std=0.01)
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            with torch.no_grad():
                ...
                action, _, logprob, _, value = agent.get_action_and_value_from_latents(
                    rollout_latents,
                    hl_support,
                )
