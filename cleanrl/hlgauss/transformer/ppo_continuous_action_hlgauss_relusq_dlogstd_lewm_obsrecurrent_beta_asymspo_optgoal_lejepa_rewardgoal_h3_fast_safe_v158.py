# v158: safer faster multi-step LEJEPA reward-imagined goal MPC.
#
# Keeps v156's controller semantics: every env step replans from the current
# observed state, and ActionSolver starts from the independent seed sequence
# rather than the GoalSolver witness action. Performance changes are limited to
# lower-risk overhead reductions: defer planner diagnostic host syncs to the
# rollout summary and use a smaller but still nontrivial goal-reaching
# refinement budget.
#
