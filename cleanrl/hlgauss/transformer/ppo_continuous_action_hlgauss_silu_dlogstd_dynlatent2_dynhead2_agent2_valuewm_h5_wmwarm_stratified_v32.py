...
# - a 2-layer dynamics transformer over obs tokens plus 2 shared latent tokens and 2 dyn-head tokens
...
class Agent(nn.Module):
    ...
    def dynamics_step(self, summary_tokens, action):
        ...
        _, dyn_head_tokens = self._split_summary_tokens(pred_next_summary)
        reward_features, termination_features = self._dyn_head_features(dyn_head_tokens)
