...
# - v86: keeps the state-conditioned target outcome embedding but blocks
#   reward/termination decoder gradients into predicted tokens; the target tokenizer/readout
#   carries outcome semantics while the predictor learns them through JEPA MSE
import os
import random
import sys
import time
...
class Args:
    ...
    """retained for CLI compatibility; v86 uses learned state-conditioned outcome readout heads"""
