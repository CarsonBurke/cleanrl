...
class Args:
    ...
    """number of summary steps the predictor can attend over; v60 defaults to current state/action only"""
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for epoch in range(args.wm_update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                sigreg_latents = [
                    sigreg_window_latents[:, horizon_idx, :NUM_STATE_TOKENS].reshape(mb_size, -1)
