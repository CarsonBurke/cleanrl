...
if __name__ == "__main__":
    ...
    def dynamics_diagnostics(
        ...
        try:
            ...
            prev_reward_probs = reward_support.project(flat_prev_rewards[sample_inds])
            summary_history = [
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for epoch in range(args.wm_update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                has_prev_outcome = b_current_has_prev_outcomes[mb_inds]
                prev_reward_probs = reward_support.project(b_current_prev_rewards[mb_inds])
                ...
                sigreg_latents = [
                    sigreg_window_flat[:, 0]
                ]
                sigreg_valids = [has_prev_outcome]
