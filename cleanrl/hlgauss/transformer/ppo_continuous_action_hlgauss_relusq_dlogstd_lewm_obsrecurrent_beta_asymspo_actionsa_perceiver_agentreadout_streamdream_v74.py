...
class Agent(nn.Module):
    def __init__(
        ...
        self.pred_layers = nn.ModuleList(
            [
                PredictorTransformerBlock(MODEL_DIM, NUM_Q_HEADS, NUM_KV_HEADS, FFN_MULT, dropout=PRED_DROPOUT)
...
if __name__ == "__main__":
    ...
    @torch.no_grad()
    def build_dream_prompt_context(flat_obs, rollout_action_features, rollout_boundaries):
        ...
        try:
            ...
            for start in range(0, total_starts, chunk_size):
                ...
                chunk_action_features = [
                    action_features[start:end] for action_features in prompt_action_feature_history
                ]
