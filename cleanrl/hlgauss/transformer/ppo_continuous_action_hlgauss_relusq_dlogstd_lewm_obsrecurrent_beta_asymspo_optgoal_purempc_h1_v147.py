# v147: pure optimal-goal gradient-solver MPC.
#
...
# - actor policy-gradient, PrefPoE, and planner-action distillation are off;
# - the actor network is only legacy scaffolding around the shared critic/value.
#
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            elif args.planner_bootstrap_random_actions and global_step < args.planner_start_step:
                with torch.no_grad():
