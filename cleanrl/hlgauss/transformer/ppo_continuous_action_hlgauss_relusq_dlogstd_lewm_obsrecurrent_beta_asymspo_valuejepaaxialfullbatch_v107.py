...
# - v107: uses a full-GPU dream generation path by default, avoiding CPU staging when
#   the full dream buffer fits in one build chunk.
import os
import random
import sys
import time
...
class Args:
    ...
    dream_build_batch_size: int = 0
    """number of real rollout starts to dream at once; <=0 builds all starts on GPU"""
