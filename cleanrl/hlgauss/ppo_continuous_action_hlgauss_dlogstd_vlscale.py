# HL-Gauss + Direct Log-Std + Value-Loss Scaling for PPO
#
# Policy loss weighted by scale = 1 + alpha * per_sample_CE_loss.
# High value-error states get amplified — no suppression, no sigmoid.
...
class Args:
    ...
    vl_alpha: float = 1.0
    """scaling factor for value-loss weighting of policy gradient"""
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                with torch.no_grad():
                    scale = 1.0 + args.vl_alpha * v_loss_per_sample.detach()
