# Dreamer4-style RMSNorm+SiLU + SymLog HL-Gauss (no vclip) + Direct Log-Std + DPG
# DPG gates policy gradient with sigmoid(advantage * surprisal / eta),
# where surprisal = -logprob from rollout policy. Uses RAW advantages before
# normalization to preserve magnitude signal.
import os
import random
import time
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                # DPG: Delight gate uses RAW advantages (before normalization)
                with torch.no_grad():
