# HL-Gauss + Direct Log-Std + DG with Value-Loss Surprisal for PPO
#
# Combines:
...
#     Uses per-sample HL-Gauss CE loss as surprisal signal instead of -logprob,
#     so the gate stays meaningful even when policy entropy is low.
