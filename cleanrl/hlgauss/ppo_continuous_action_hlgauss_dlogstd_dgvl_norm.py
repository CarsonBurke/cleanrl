# HL-Gauss + Direct Log-Std + DG with Normalized Value-Loss Surprisal
#
# Same as dgvl but z-normalizes the delight signal per minibatch so
# eta=1 works universally across environments regardless of reward scale.
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                with torch.no_grad():
                    ...
                    vl_surprisal = vl_surprisal / (vl_surprisal.mean() + 1e-8)
