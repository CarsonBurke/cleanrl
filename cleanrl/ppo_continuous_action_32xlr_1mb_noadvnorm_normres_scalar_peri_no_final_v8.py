# Peri-RMS scalar PPO, v8: remove only the final actor/critic trunk norms.
# Keep branch input/output RMS, residual gates and 1/sqrt(width) readout scaling.
# Matched v7 four-epoch run: reward normalization and clipped MSE retained;
# no gradient clipping. Hypothesis: let residual-stream magnitude reach the heads.
import os
import random
import time
