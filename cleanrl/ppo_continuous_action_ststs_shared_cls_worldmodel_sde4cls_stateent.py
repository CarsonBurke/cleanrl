# PPO + World model + SDE + Dreamer4-style state prediction entropy bonus.
#
# Fork of worldmodel_sde4cls v2 (fresh latents) with a 5th CLS token: state_pred.
# 5 CLS tokens: actor, critic, dynamics, SDE, state_pred.
# The state_pred CLS predicts next-step dynamics latent as Gaussian (mean, log_var).
# log_var sum is added to reward as intrinsic exploration bonus.
# Gaussian NLL loss calibrates uncertainty during PPO updates.
import os
import random
import time
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                # World model loss on fresh latents
                with torch.no_grad():
