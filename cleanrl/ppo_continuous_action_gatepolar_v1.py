# Base Beta PPO with the shared GatePolar optimizer, v1 (optimizer swap only).
...
class Args:
    ...
    """adam (base control) or gate_polar (polar trunks, Adam heads, resistance-gated decay)"""
...
def validate_args(args):
    ...
    if args.optimizer not in {"adam", "gate_polar"}:
        raise ValueError("optimizer must be adam or gate_polar")
    return args
