# HOPSD v21 — the upside-down teacher: outcome-conditioned rationalizer, improvement
# by counterfactual QUERY instead of tilted weights.
# =====================================================================================
...
class Args:
    ...
    teacher_sees_g: bool = True      # v21: g in the context is the POINT (no tilt left to collapse)
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        with torch.no_grad():
            ...
            # v21: the counterfactual query context — identical except g -> g*.
            actor_ctx_star = [obs, near_mean, near_std, far_mean, far_std]
            if args.teacher_sees_g:
                actor_ctx_star.append(torch.full_like(g, args.query_grade).unsqueeze(-1))
            actor_ctx_star.append(fut_valid_frac.unsqueeze(-1))
            teacher_actor_in_star = torch.cat(actor_ctx_star, dim=-1)
