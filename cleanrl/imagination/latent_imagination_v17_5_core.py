# v17.5 — Bug fixes for dreamerv3/dreamer4 alignment
#
# Fixes from v17 (v16):
...
def main(args_class=Args):
    ...
    def train_step():
        ...
        actor_loss = pmpo_loss + args.pmpo_kl_weight * kl_loss
    ...
    print(f"Starting latent_imagination_v17.5 on {args.env_id} with {args.num_envs} envs")
