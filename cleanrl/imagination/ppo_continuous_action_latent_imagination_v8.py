...
# v8: persistent prior, recurrent temporal context, a separate imagination
# actor that becomes the acting policy after warmup, and a twohot imagination
# value head trained inside imagined rollouts.
@dataclass
