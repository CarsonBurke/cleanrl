...
#
# v21 keeps the v20 tokenized transformer design, but scales the world model
# down to better match low-dimensional MuJoCo control tasks. The environment
# state spaces here are tiny, so a smaller transformer should give better
# compute efficiency and may regularize the learned dynamics.
import math
import os
import random
import time
...
def main(args_class=Args):
    ...
    print(f"Starting latent_imagination_v21 on {args.env_id} with {args.num_envs} envs")
