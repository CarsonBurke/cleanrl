# Ablation: v8 WITHOUT imagination-phase training.
# The world model still trains (latent bottleneck, target encoder,
# value consistency all active), but the imagination rollout phase
# that provides multi-step value targets and policy gradients is disabled.
# Tests whether the imagination phase itself drives performance,
# or whether the latent representation + value consistency alone suffice.
...
class Args(latent_imagination_v8_core.Args):
    ...
    # ABLATION: disable imagination phase entirely
