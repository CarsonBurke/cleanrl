# Ablation: v8 with ALL THREE mechanisms removed simultaneously.
# - value_consistency_coef=0.0 (no value consistency loss)
# - imagination_loss_coef=0.0 (no imagination phase)
# - target_encoder_tau=1.0 (no EMA target encoder)
#
# What remains: the shared encoder architecture, the world model training
# (transition + reward prediction on detached latents), and PPO on latent space.
