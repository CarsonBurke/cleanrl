# Ablation: v8 WITHOUT target encoder stabilization.
# Sets target_encoder_tau=1.0, meaning the target encoder is always
# an exact copy of the online encoder (no EMA lag). This removes the
# stable representation anchor that the world model trains against.
# Tests whether the EMA target encoder is essential for grounding
# the latent space and preventing value drift.
...
class Args(latent_imagination_v8_core.Args):
    ...
    # ABLATION: disable EMA target encoder (target = online at all times)
