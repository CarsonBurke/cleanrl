# Ablation: v8 WITHOUT value consistency loss.
# Tests whether the world-model value consistency term
# (||V(pred_next_latent) - V(target_next_latent)||^2) is key to
# maintaining high explained variance and performance.
...
class Args(latent_imagination_v8_core.Args):
    ...
    # ABLATION: disable value consistency
