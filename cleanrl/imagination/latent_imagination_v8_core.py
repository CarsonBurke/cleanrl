...
def imagination_parameters(agent: Agent):
    params = []
    params.extend(agent.imagination_actor_mean.parameters())
    params.append(agent.imagination_actor_logstd)
    params.extend(agent.imagination_value_head.parameters())
    params.extend(agent.imagination_context_proj.parameters())
    params.extend(agent.imagination_value_context_proj.parameters())
    return params
