...
#
# v25 keeps the v24 Dreamer4-inspired transformer features but tightens the
# implementation around the actual hot paths: vectorized episode bookkeeping,
# vectorized history append, one-pass seed-state construction, and cheaper
# cached attention masking. The goal is to stay architecturally close to the
# Dreamer4 reference where it matters for this MuJoCo setup while reducing
...
def main(args_class=Args):
    ...
    print(f"Starting latent_imagination_v25 on {args.env_id} with {args.num_envs} envs")
