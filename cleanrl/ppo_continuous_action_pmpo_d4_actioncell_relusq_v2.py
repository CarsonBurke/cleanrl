# PMPO-D4 + ReluSq + TanhNormal action-cell policy v2.
#
...
#
# v1 failure: full categorical KL over every action cell produced rare but
# enormous tail-cell spikes, even while mean cell entropy and max-prob looked
# healthy. v2 keeps the action-cell PMPO actor signal, but uses closed-form
# latent Normal KL as the trust-region penalty and early-stop metric. Cell KL is
# logged only as a diagnostic. PPO mode still uses density log-probs.
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                if args.policy_objective == "ppo":
                    ...
                    cell_reverse_kl = kl_from_log_probs(
                    ...
                    if args.pmpo_reverse_kl:
                        ...
                        reverse_kl = kl_divergence(new_dist, old_dist).sum(-1).mean()
