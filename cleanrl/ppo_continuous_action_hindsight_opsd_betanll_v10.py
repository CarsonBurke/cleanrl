...
#
# PPO + Hindsight-Conditioned OPSD Teacher, Beta teacher beta-NLL v10 pure OPSD actor.
#
# Hypothesis:
...
# v10 removes PPO actor optimization and treats OPSD as the actor objective:
...
# hyperparameter. No advantage-weighted distillation, teacher loss coefficient,
# or teacher concentration cap is used.
import os
import random
import time
