# Sparser-JIT NN PPO: Beta PPO with a compact, fixed sparse MLP trunk.
# The actor and critic use width-48 hidden layers with 50% deterministic
# block-free connectivity; masked gradients keep inactive edges permanently
# zero. The existing torch.compile learner graphs fuse the smaller dense
# representation while the host mirror preserves native rollout throughput.
# Hypothesis: removing redundant hidden connections reduces update cost and
...
class Args:
    ...
    hidden_width: int = 48
    """hidden width for the compact sparse actor and critic trunks"""
...
def main():
    ...
    try:
        ...
        writer.add_text(
            "policy",
            "Beta PPO; width-48 fixed 50%-density sparse hidden layers; "
