# SAC v3: v2 minus RMSNorm. ReLU^2 trunk only.
#
# v2 (ReLU^2 + RMSNorm) tracked above baseline early then crossed below.
# Ablate the norm to see whether ReLU^2 alone is the win or the regression.
# Trunk in both actor and critic: Linear -> ReLU^2 -> Linear -> ReLU^2,
# width 256. Everything else unchanged from v2.
import math
import os
import random
import time
