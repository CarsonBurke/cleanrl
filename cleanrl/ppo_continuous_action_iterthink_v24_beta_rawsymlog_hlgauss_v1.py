# PPO + IterThink v24 Beta raw-return symlog HL-Gauss critic v1.
#
...
# ±100k margin range. This isolates whether reward normalization was hiding or
# distorting the critic/advantage geometry.
#
...
class Args:
    ...
    v_min: float = -20000.0
    v_max: float = 20000.0
    critic_init_tau: float = 0.5   # init Z ≈ N(0, tau^2) in bin coordinates
...
class Agent(nn.Module):
    def __init__(self, envs, args):
        ...
        # prior instead of a high-variance uniform distribution.
