        ...
        if args.lewm_loss_coef > 0.0:
            ...
            for _ in range(args.lewm_update_epochs):
                ...
                for start in range(0, args.batch_size, wm_minibatch_size):
                    ...
                    # v112: no SIGReg on AR predictions. Their on-manifold pressure is
                    # the per-step attached MSE toward SIGReg'd encoder targets; a
                    # direct marginal constraint would fight the conditional-mean
                    # solution (lower-variance marginal than targets by law of total
                    # variance).
                    wm_loss = (
