...
# Instrumented reference: byte-identical learner to stiglu_sphere_v1 (the 50M
# HalfCheetah leader at 13.2k), carrying the same probes as the LeakyReluSq
# arm so weight-norm drift and branch DC contamination are comparable
# curve-for-curve rather than only at init.
...
def main():
    ...
    try:
        ...
        writer.add_text("policy", "Beta host actor; 32x LR; 1 minibatch; hypersphered SiTU-GLU trunk; no advantage normalization; trunk probes")
