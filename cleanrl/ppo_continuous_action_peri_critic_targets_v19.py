# Peri-RMS scalar PPO, v19: critic-target and optimization-frequency ablations.
# Preserve the v8 actor, full policy GAE and rollout cadence. The critic uses
# full/short traces and one pass split into independently rebootstrapped minibatches.
# Both V(s) and V(s') stay online. This is not full V-MPO or an HL-Gauss experiment.
import os
import random
import time
