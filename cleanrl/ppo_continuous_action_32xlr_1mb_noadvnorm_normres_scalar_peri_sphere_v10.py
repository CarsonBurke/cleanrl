# Peri-sphere scalar PPO, v10: unit-L2 branch inputs and outputs only.
# Keep the unprojected additive stream, gates, initialization and 1/8 readout.
# One epoch, normalized rewards and clipped scalar MSE; no gradient clipping.
# Hypothesis: smaller Peri branch updates help without dense nGPT sphere mixing.
import os
import random
import time
...
class Args:
    ...
    norm_kind: Literal["layer", "rms", "sphere"] = "sphere"
    """unit-L2 Peri branch norms; residual stream and final readout stay unnormalized"""
...
class Agent(nn.Module):
    ...
    def __init__(self, envs, *, placement="peri", norm_kind="sphere", activation="stiglu"):
        super().__init__()
