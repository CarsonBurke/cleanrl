# PPO + IterThink v24 beta d4-HL-Gauss symlog raw-return critic MLP10 obs-idx-transfer v1.
#
...
#
# MLP10 obs-idx-transfer variant: remove the DenseNet-style trunk concatenation,
# residual branch sum, x0 convex residual, and MoE. The actor/critic trunk uses
# a hidden-width ReLU-squared observation stem x0, then a plain depth-10,
# width-128 ReLU-squared MLP. Starting at hidden layer 2, each hidden perceptron
# also receives learned same-index transfer residuals from x0 and earlier
# non-immediate hidden layers in its preactivation:
#   x0[j] = stem(obs)[j]
