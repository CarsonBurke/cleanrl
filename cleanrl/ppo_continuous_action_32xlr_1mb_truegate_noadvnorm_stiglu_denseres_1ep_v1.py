...
# Truegate + dense-residual SiTU-GLU trunk with ONE actor epoch per rollout.
# Same 32x LR (9.6e-3) and dense per-channel-gated trunk as
# _truegate_noadvnorm_stiglu_denseres_v1, but actor and critic train on
...
def main():
    ...
    try:
        ...
        writer.add_text("policy", "Beta host actor; truegate; dense per-channel-gated SiTU-GLU trunk; 1 actor epoch + 10 critic epochs; no advantage normalization")
