...
if __name__ == "__main__":
    ...
    assert args.improve in ("surrogate", "distill", "both"), f"unknown improve {args.improve!r}"
    assert not (args.improve in ("surrogate", "both") and args.tr_mode == "mask" and not args.pg_clip), \
    ...
    if args.improve in ("distill", "both"):
    ...
    use_jac = args.improve in ("distill", "both")
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        # ===== THE ANALYTIC IMPROVEMENT TEACHER (improve="distill" or "both") ==========
