...
#
# PPO + Hindsight-Conditioned OPSD Teacher, Beta teacher beta-NLL v8 SiLU clip-higher.
#
# Hypothesis:
...
# v8 uses the v7 base with SiLU activations and restores the v168-style asymmetric PPO actor
# clip: the lower ratio bound stays conservative while the upper ratio bound is
# relaxed. The student never sees the hindsight context.
import os
import random
import time
