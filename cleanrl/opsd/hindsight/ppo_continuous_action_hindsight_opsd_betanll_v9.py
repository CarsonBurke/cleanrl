...
#
# PPO + Hindsight-Conditioned OPSD Teacher, Beta teacher beta-NLL v9 SiLU HL-Gauss critic.
#
# Hypothesis:
...
# v9 keeps v8's SiLU Beta policy, Beta hindsight teacher, and asymmetric
# clip-higher actor objective, but replaces the scalar MSE critic with v168's
# Dreamer3-bucket HL-Gauss categorical critic. Unlike v168, this is single-step
# value supervision only: no critic MTP rows. The support is matched to this
# file's normalized/clipped reward wrapper: reward in [-10, 10] and gamma=0.99
# implies a discounted-return range of roughly [-1000, 1000].
import os
import random
import time
