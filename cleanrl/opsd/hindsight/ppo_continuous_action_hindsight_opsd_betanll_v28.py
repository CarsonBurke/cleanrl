...
#
# OPSD v28: learned full-batch gradient matching with advantage-logit cold start.
#
# v28 note: v25 learns, but starts from a uniform distribution that wastes early
# updates on behavioral cloning. v28 keeps the full learned distribution over every
# sample and the v25 student-gradient alignment objective, but initializes the
# weighter with a learnable advantage-logit skip: score_i = c*A_z_i + residual_phi.
# The residual and scale are learned; there is no hard top-k or fixed exp-A rule.
#
