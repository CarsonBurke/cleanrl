# HOPSD v41 — dual improvement operators (local DPG + global sampled search); distributional-Q arm.
# =====================================================================================
...
#   bit-for-bit from the logged kl) — v41 raises its budget 0.6->1.5 nats since ~1.8 is followable.
...
#   (2) DUAL retune (budget 1.5, eta 0.5, floor 0.02; extracted to unit-tested dual_update_lam).
