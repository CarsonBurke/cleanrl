# HOPSD v1 — Hindsight On-Policy Self-Distillation (OPSD, arXiv 2601.18734) for continuous control.
# =====================================================================================
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        with torch.no_grad():
            ...
            teacher_actor_in = torch.cat(
                [obs, fut_mean, fut_std, g.unsqueeze(-1), fut_valid_frac.unsqueeze(-1)], dim=-1
            )
