# HOPSD v22 — outcome-context teacher: the trajectory's PHYSICAL playout joins phi.
# =====================================================================================
...
class HindsightTeacher(nn.Module):
    ...
    def __init__(self, obs_dim, act_dim, args):
        super().__init__()
        H = args.hidden
        # v22: action windows (4A) + state-delta windows (4S) + valid_frac
        actor_in = obs_dim + 4 * act_dim + 4 * obs_dim + 1 + (1 if args.teacher_sees_g else 0)
        critic_in = obs_dim + 4 * act_dim + 4 * obs_dim + 1
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        with torch.no_grad():
            ...
            # v22: pooled future state DELTAS — how the trajectory physically played out
            s_near_mean, s_near_std, s_far_mean, s_far_std, _ = build_future_features(
            ...
            actor_ctx = [obs, near_mean, near_std, far_mean, far_std,
                         s_near_mean, s_near_std, s_far_mean, s_far_std]
            ...
            teacher_critic_in = torch.cat(
                [obs, near_mean, near_std, far_mean, far_std,
                 s_near_mean, s_near_std, s_far_mean, s_far_std,
