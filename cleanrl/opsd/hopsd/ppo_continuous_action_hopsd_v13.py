# HOPSD v13 — per-state MPO E-step teacher: action-conditioned hindsight Q + candidate-cloud tilt.
# =====================================================================================
...
class HindsightTeacher(nn.Module):
    ...
    Critic input: [obs, future-action mean/std per dim, valid frac, z]  (action-conditioned Q_T)
    """
    ...
    def __init__(self, obs_dim, act_dim, args):
        ...
        critic_in = obs_dim + 2 * act_dim + 1 + act_dim  # v13: +act_dim for the conditioning action z
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        with torch.no_grad():
            ...
            # teacher_critic_in holds the phi features ONLY; the conditioning action z is
            # concatenated per candidate below (and per realized action at train time).
