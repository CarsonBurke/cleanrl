# PPO + IterThink v24 beta d4-HL-Gauss symlog DGAE v1.
#
# Variant hypothesis: keep the strong d4-HL-Gauss symlog critic exactly as-is, but
# use Distributional GAE (arXiv:2507.17530) for the POLICY advantage. The critic
# still trains on the scalar GAE lambda-return projected by HL-Gauss. Only the
# actor's advantage recursion swaps scalar TD errors for the paper's
...
# Only intended algorithmic change vs d4hlgauss_symlog_v1: policy advantage
# estimator. Reward normalization/clipping, support, smoothing, critic init,
# target CE loss, rankgauss, and PPO settings stay matched.
#
