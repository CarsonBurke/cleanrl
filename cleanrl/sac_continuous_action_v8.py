# SAC v8: v4 optimistic HL-Gauss critic + denser support, no auxiliary loss.
#
# Keeps v4's pure categorical CE critic objective and optimistic default head
# initialization. The only algorithmic change is a denser, narrower raw support
# to improve late actor-facing Q ranking while diagnostics track clipping and
# projection bias. No scalar TD auxiliary is used.
#
# Hypothesis: v4's late plateau is from coarse 35-point bins and smoothing, not
# support overflow; use ~12.5-point bins over the observed Q range.
import math
import os
import random
import time
