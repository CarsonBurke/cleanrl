# V-MPO v28 — raw-reward 51-bin HL-Gauss symlog critic.
#
# Controlled derivative of v27 removing only discounted-return reward
# normalization. Fifty-one bins partition the symmetric scalar range
# [-20,000, 20,000] uniformly between symlog edges ±log(20,001); sigma is 0.75
# transformed-bin widths. The output head remains bias-free with zero weights,
# and values decode as E[symexp(bin)] rather than symexp(E[bin]). PopArt remains
