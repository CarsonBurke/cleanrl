# V-MPO v36 — ±1,000 symlog support with V30 smoothing.
#
# Controlled V34 follow-up separating support range from target smoothing.
# V34's fixed 0.75 sigma-to-bin ratio narrowed coordinate-space sigma from
# 0.2971 to 0.2073 when the support shrank. This variant uses ratio 1.075107 so
# its ±1,000 support retains V30's 0.2971 symlog Gaussian sigma. All other V34
# and V30 machinery is unchanged.
...
class Args:
    ...
    value_sigma_to_bin_ratio: float = 1.0751073674959466
