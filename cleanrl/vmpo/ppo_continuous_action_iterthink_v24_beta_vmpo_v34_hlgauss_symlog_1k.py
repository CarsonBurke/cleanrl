# V-MPO v34 — reward-normalized Dreamer moment-matched HL-Gauss at ±1,000.
#
# Controlled derivative of v30 changing only the scalar support range. With
# normalized rewards clipped to ±10 and gamma 0.99, the discounted-return bound
# is ±10 / (1 - gamma) = ±1,000. Fifty-one symexp-spaced centers, symmetric
# paired decoding, moment-matched labels, and adaptive target behavior remain
# unchanged.
