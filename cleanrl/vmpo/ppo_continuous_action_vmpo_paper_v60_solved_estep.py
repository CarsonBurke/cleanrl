# V-MPO v60 — solve the shared replica-averaged E-step dual (arXiv:1909.12238).
# Single-factor correction of v59: replace raw-unit eta Adam with the minimizer
# of the SAME convex dual, mean replica KL = epsilon_eta. A frozen checkpoint
# needed eta~32, not learned eta~1.3; solving restored ESS and gradient agreement.
# Gaussian/PopArt/returns, alpha Adam, raw inputs and fixed target hold unchanged.
...
def main():
    ...
    with ExitStack() as resources:
        ...
        writer.add_text("paper_reference", "arXiv:1909.12238, Eqs 1-6/25-27, Appendix F/Table 7. "
                        ...
                        "Single v59 algorithm change: numerically minimize shared E-step dual instead of one eta Adam step. "
