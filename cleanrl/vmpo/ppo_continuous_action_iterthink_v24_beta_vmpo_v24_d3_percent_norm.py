# V-MPO v24 — no PopArt with D3 percentile advantage scaling.
#
# Controlled derivative of v23 applying the canonical D3 divide-only scale:
# max(1, P95(return)-P5(return)) from each fresh full rollout. Reward
# normalization remains vectorized and independent per environment; the scalar
# critic trains in normalized-reward units. With v22's exact fixed-KL eta solve,
# the common positive advantage scale should cancel through eta and leave
# E-step weights unchanged; this run measures residual numerical effects.
