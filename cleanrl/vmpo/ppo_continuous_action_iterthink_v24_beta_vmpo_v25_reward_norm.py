# V-MPO v25 — adaptive target promotion with vectorized reward normalization.
#
# Controlled derivative of v22 enabling only standard discounted-return reward
# normalization and clipping normalized rewards to [-10, 10]. It preserves the
# original 64 independent RunningMeanStd streams but updates them in one NumPy
# operation rather than 64 singleton wrappers. Episode logs remain raw.
