# V-MPO v64 — accelerated v60 baseline, with optional reward normalization.
# Restore v60's shared exact eta and BOTH alpha multipliers in Adam1e-4.
# Do not retain v62's faster covariance dual: measured returns select v60.
# Runtime-only path uses event-protected packed tail/truncation uploads while
# preserving critic batch layouts, shifted n-step returns and batch PopArt.
# Compare raw rewards against v30-style per-env reward RMS plus clip10.
# Keep raw observations, 64x39, eight replicas, fixed100 holds and initial std .3.
# CUDA FP32 preserves the host-policy and tiny-KL numerical fidelity contract.
...
def main():
    ...
    with ExitStack() as resources:
        ...
        writer.add_text("paper_reference", "arXiv:1909.12238, Eqs 1-6/25-27, Appendix F/Table 7. "
                        ...
                        "v60 algorithm retained: solved shared eta, both alpha multipliers in Adam1e-4. "
                        "Optional v30-style per-env discounted-return RMS and clip10 includes warmup; "
                        "episode and deterministic evaluation returns remain raw. "
                        "Packed pinned bootstrap uploads and asynchronous rollout transfer preserve "
                        "original FP32 critic batch layouts and shifted returns. "
