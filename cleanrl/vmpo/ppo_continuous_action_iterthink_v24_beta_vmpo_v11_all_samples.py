# V-MPO v11 all-sample E-step — exact-eta V-MPO over the full rollout.
#
# v10 uses the paper's top-half filter in the nonparametric E-step. This
# isolated ablation sets topk_fraction=1.0 so every rollout sample participates.
#
# Exact eta solving, seeded phase staggering, 39-step rollout geometry, GAE,
# target cadence, the one-epoch joint update, target-policy ownership, PopArt,
# and the full-width ReLU-squared IterThink Beta model remain unchanged.
