# V-MPO v15 FAST-ALPHA — faster parametric KL duals on v10 GAE.
#
# v10's alpha multipliers share the network's 3e-4 Adam rate and adjust slowly
# relative to their mean and concentration KL constraint residuals. This
# isolated ablation gives alpha_mean and alpha_concentration a 1e-2 learning
# rate while retaining 3e-4 for every network parameter.
#
# GAE, exact eta, seeded phase staggering, the one-full-batch joint update,
# target-policy ownership, PopArt, and the full-width ReLU-squared IterThink
# Beta model are unchanged.
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        if should_log:
            ...
            writer.add_scalar("charts/alpha_learning_rate", args.alpha_lr, global_step)
