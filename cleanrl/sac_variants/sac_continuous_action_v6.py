# SAC v6: v4 HL-Gauss critic with neutral prior and scalar-target diagnostics.
#
# This intentionally returns to v4's scalar SAC Bellman target instead of
# selecting/copying a target critic's whole distribution. The critic remains an
# HL-Gauss categorical scalar regressor, but clipped double-Q stays scalar:
# y = r + gamma * (min(E[Z1], E[Z2]) - alpha log pi).
#
# Changes from v4:
# - initialize the HL head to project Q=0, removing the optimistic midpoint prior
# - add cheap support/projection/disagreement diagnostics
# - enforce CUDA before creating run artifacts
import math
import os
import random
import time
