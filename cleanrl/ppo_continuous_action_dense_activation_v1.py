# Dense activation sweep for bounded-action Beta PPO.
# Compare ReLU, ReLU-squared, LeakyReLU(0.5)-squared, and SiTU-Glu trunks
# at identical width, depth, optimizer, rollout topology, and PPO loss.
# The host mirror includes exact FP32 implementations for every activation.
import os
import random
import time
