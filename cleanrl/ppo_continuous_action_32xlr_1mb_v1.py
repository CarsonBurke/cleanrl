# 32x LR + 1 minibatch on the ppo_ab_new host-actor trainer.
# Host MLP acts during rollout; one batched device forward produces old
# log-probabilities and values after the packed upload. Defaults: lr=9.6e-3,
# num_minibatches=1. PPO loss, clip, critic and Beta head are unchanged.
