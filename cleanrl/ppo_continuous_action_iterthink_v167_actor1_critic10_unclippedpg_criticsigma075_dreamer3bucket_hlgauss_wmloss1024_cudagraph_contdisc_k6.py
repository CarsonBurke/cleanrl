# PPO + IterThink v167 actor1-critic10-unclippedpg-criticsigma075-dreamer3bucket-hlgauss-wmloss1024-cudagraph-contdisc-k6.
#
# v166 + split real/imagination update pressure consistently: actor updates only
# for one epoch while critic trains for all update_epochs=10. Policy ratio
# clipping and KL early-stop are removed from both real and imagined policy
# losses, but KL/ratio/clipfrac diagnostics are still logged for actor updates.
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                if actor_active:
                    ...
                    # Unclipped policy-gradient objective. clipfrac/ratio diagnostics
                    # above still report how often PPO clipping would have activated.
