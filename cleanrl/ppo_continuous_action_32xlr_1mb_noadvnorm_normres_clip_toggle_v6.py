# Pre-RMS SiTU-GLU PPO, v6: explicit gradient-clipping ablation.
# Preserve scalar value clipping, architecture, initialization and Adam.
# Disabling gradient clipping measures norms without mutating gradients;
# distinguish the rare clipping intervention from the PPO epoch-count effect.
import os
import random
import time
