# Delightful Policy Gradient with Gym-calibrated state Gaussian v20.
#
# Keeps v19's clipped latent-Gaussian policy, batch-256 DG loop, and paired
# same-state Q baseline. V20 adapts covariance to Gym HalfCheetah's control
# penalty: every state/action scale is smoothly bounded in [0.1, 1.0] and
# initialized at exp(-1.5), matching v18's successful early exploration while
# preventing both v18's collapse and v19's statewise scale explosion. Sigma
# remains fully state- and action-dependent; there is no global parameter.
...
if __name__ == "__main__":
    ...
    if args.env_id != "HalfCheetah-v4":
        raise ValueError("v20 is tuned for HalfCheetah-v4")
