# Delightful Policy Gradient with paired state baselines v18.
#
# Keeps v17's paper-sized batch of 256, frequent on-policy DG actor updates,
# Q(s,a) replay critic, raw-reward EMA scaling, hard targets, and one-step TD.
# V18 replaces v17's invalid global Q centering with one independent policy
# action per same state. Its Q value is an unbiased one-sample estimate of V(s),
# retaining state-conditioned advantages without v16's eight-sample baseline.
# Four 256-sample critic updates preserve the 4:1 critic replay ratio.
...
if __name__ == "__main__":
    ...
    if args.env_id != "HalfCheetah-v4":
        raise ValueError("v18 is tuned for HalfCheetah-v4")
