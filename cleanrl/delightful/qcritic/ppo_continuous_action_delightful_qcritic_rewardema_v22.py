# Delightful Policy Gradient with stable squashed state Gaussian v22.
#
# Keeps v21's batch-256 DG loop, deterministic same-state Q baseline, and
# smoothly bounded state-dependent sigma. V22 restores v18's successful
# tanh-squashed action geometry and transformed-density surprisal while keeping
# sigma in [0.1, 1.0]. This directly targets v18's covariance collapse without
# the clipped-Gaussian geometry that stalled v19-v21. Sigma remains state- and
# action-dependent; there is no global parameter.
...
if __name__ == "__main__":
    ...
    if args.env_id != "HalfCheetah-v4":
        raise ValueError("v22 is tuned for HalfCheetah-v4")
