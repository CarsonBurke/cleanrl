# Pan Goal Solver v5: direct Pan hindsight toward a continuously refreshed ideal.
#
# A reward-free LeJEPA learns observation tokens and temporal control belief.
# Hindsight first-action likelihood and discounted occupancy train the follower.
# Reward trains only a global affine goal ray P(y)=mu+s(y)d. Its deterministic
# point is recomputed every environment step and P is updated every train cycle.
