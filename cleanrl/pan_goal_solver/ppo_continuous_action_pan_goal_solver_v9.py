# Pan Goal Solver v9: direct control toward a continually revised open goal.
#
...
# reward head learns reward MSE from detached predicted-next latents; freezing
# that head while maximizing R(G) revises the goal head every training cycle.
