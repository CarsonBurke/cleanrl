# Pan Goal Solver v10: scale-invariant reward belief for an open latent goal.
#
...
# Hypothesis: improving representation and reward belief progressively sharpen
# an unreachable ideal whose direction pushes the direct follower to the limit.
