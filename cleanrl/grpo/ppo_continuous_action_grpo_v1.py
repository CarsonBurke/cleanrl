# GRPO-style critic-free PPO for continuous control.
...
#
# Advantage estimation (idiomatic GRPO port):
...
#
# Why it can work: the per-step group z-score is an unbiased baseline
# whenever the grouped samples are exchangeable, and a low-variance
# proxy for A(s,a) when envs are roughly synchronized in episode phase.
import os
import random
import time
