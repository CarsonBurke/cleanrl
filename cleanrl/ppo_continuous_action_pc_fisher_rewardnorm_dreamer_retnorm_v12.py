# Predictive-coding actor-critic with reward-normalized Dreamer return scaling v12.
#
# Exact v11 interaction ablation: restore v3 reward normalization and [-10, 10]
# reward clipping while retaining Dreamer's percentile return-range actor scaling,
# the unscaled critic TD error on those normalized rewards, and zero weight decay.
import math
import os
import random
import time
