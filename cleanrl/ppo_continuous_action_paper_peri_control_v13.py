# Matched Peri attention control, v13.
# Shared learned token offsets start N(0,1), avoiding an all-zero RMS fixed point.
# Hypothesis: isolate the MLP-to-attention backbone confound before comparing norms.
# Peri RMS normalizes each attention/FFN branch input and output; no final norm.
...
class Args:
    ...
    norm_method: Literal["peri", "siamese", "span", "hybrid"] = "peri"
...
class Agent(nn.Module):
    ...
    def __init__(
        self, envs, *, norm_method="peri", token_width=32, n_tokens=4, n_heads=2, n_blocks=3
    ):
        super().__init__()
