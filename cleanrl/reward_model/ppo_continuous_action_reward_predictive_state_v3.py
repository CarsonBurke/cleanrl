# PPO + independently projected future-reward predictive-state critic, v3 (RNG-paired).
#
...
# consistency train the predictive state. A discounted projection loss controls
# correlated sequence errors that coordinatewise MSE cannot see. TD0, prefix projection,
# vector prediction, and PPO receive independent gradient budgets. Reward norm is off.
import os
import random
import time
