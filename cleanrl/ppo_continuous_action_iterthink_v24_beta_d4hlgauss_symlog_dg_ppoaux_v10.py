# PPO + IterThink v24 beta d4-HL-Gauss symlog critic + replay-DG AUXILIARY v10.
#
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                if args.dg_aux_coef > 0:
                    ...
                    aux_gate, aux_surprisal, _, _ = delightful_aux_gate(
                        aux_u,
                    ...
                    aux_pg_loss = -(aux_gate.detach() * aux_u * aux_logprob).mean()
