# Pre-RMS SiTU-GLU PPO with matched tanh-Gaussian exploration, v1.
# Base: ppo_normres_indclip_v4_norm_mse_valueclip_50M.
# The base's normalized residual trunks, 32x learning rate, raw GAE,
# clipped value MSE, and independent gradient budgets are unchanged.
# Gaussian uses the stiglu_control_v2_beta_fixed calibration: its initial
# tanh-action variance matches the Beta control while retaining true native
# Gaussian likelihoods and stochastic host-side rollout sampling.
import math
import os
import random
import time
