...
# - Train A_r to reconstruct GAE advantages, then mix a detached prediction into
#   the actor advantage. This asks whether future trajectory structure can
#   denoise credit assignment without replacing PPO's reliable bootstrap path.
#
# Hypothesis:
# MuJoCo locomotion has delayed, phase-coupled consequences. A small
# future-conditioned advantage component should make the policy gradient less
# myopic than one-step TD residuals while remaining anchored to PPO/GAE.
import os
import random
import time
...
class Args:
    ...
    retro_policy_mix: float = 0.25
    """fraction of detached retrospective critic prediction mixed into policy advantages"""
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        with torch.no_grad():
            ...
            b_policy_advantages = (
                (1.0 - args.retro_policy_mix) * b_advantages + args.retro_policy_mix * b_retro_advantages
            )
