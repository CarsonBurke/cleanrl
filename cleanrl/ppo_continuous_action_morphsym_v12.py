# PPO + Morphogenic Symmetry v12  --  WIDTH AS A SAMPLED ACTION.
#
# MOTIVATION. In v5..v11 per-template token width was a DETERMINISTIC gate. It never moved:
# it sits pinned at the ceiling (~D) because the task wants full width and the compute tax is
# a tiny counter-gradient with no way to *try* narrower and discover it is fine. A pinned
# smooth parameter cannot explore.
#
...
from cleanrl.ppo_continuous_action_morphcompute_v9 import SAMPLE_EPS, effective_support, make_env, mean_stat
...
from cleanrl.ppo_continuous_action_morphsym_v9 import Args as V9Args, Agent as V9Agent, SymGraph9
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            with torch.no_grad():
                action, z, logprob, _, value, _, _, last_stats, width = agent.get_action_and_value(next_obs)
            ...
            # compute-in-the-reward: penalise active-channel fraction of the sampled width
