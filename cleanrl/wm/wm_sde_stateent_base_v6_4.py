# PPO + WM + Dreamer4-style policy mean/log-var head + state entropy bonus, with D4-style small PPO epoch count.
#
# Fork of wm_sde_stateent_base_v6_1.
...
# repeated imagination updates after each real rollout. Relative to v6.1, this
# variant only reduces PPO update epochs to 2 to match the Dreamer4 trainer's
# smaller per-batch epoch count.
import os
import random
import time
