# ABLATION: no_stateent — Remove the state entropy intrinsic reward bonus.
# The state prediction head still exists (for its loss signal to the backbone),
# but its log_var is no longer added to rewards. Tests whether the intrinsic
# motivation from state prediction uncertainty is driving performance.
#
