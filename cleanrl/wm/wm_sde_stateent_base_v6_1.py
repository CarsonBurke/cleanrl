# PPO + WM + Dreamer4-style policy mean/log-var head + state entropy bonus, with a more GPU-dense regime.
#
...
# a separate SDE CLS; one actor latent emits both mean and log-variance.
import os
import random
import time
