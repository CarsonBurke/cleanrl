# PPO + WM + PMPO, aligned to Dreamer4's online SimTrainer cadence.
#
# Fork of wm_sde_stateent_base_v2.
# This version keeps the v7 modeling and PMPO path, but changes the default
# training cadence to match Dreamer4's online SimTrainer as closely as this
# PPO-style file can: one env, short real rollouts, one minibatch, two epochs,
# and no separate imagination phase by default.
import os
import random
import time
...
class Args:
    ...
    imagine_updates_per_iter: int = 0
