# PPO + IterThink v24.12 (BETA LOGIT ACTION FLOW, Y-REPLAY). From v24.9.
#
# Isolated ablation: replay the exact post-flow logit `y1` instead of clamped
# bounded `z1=sigmoid(y1)`. This removes the possible safe_logit(clamp(sigmoid))
# mismatch when the flow approaches action boundaries. Env actions and CFM targets
# still use bounded z coordinates derived from y1.
#
