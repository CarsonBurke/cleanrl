...
#
# OPSD v25: learned full-batch actor-gradient matching distribution.
#
# v25 note: v24's held-out one-step meta objective was too indirect and stayed near
# behavioral cloning. v25 keeps a learned categorical distribution over every
# minibatch sample, but trains it by direct gradient alignment: the weighted-MLE
# actor gradient induced by the learned weights is matched to a positive-advantage
# policy-improvement gradient for the current actor. The actor itself is still
# updated only by detached nonnegative mean-1 learned weights; no fixed top-k or
# exp-advantage rule is used for the actual update.
#
