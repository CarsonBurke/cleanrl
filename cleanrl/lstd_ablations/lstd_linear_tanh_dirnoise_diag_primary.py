"""Diagonal primary: flip the balance. Large state-dependent diagonal (~[0.1, 0.4]) is the
primary noise source. Small low-rank component provides cross-action correlation as a
complement. Amp range scaled down so low-rank contributes ~0.05 variance vs diagonal ~0.2.
"""
import os
import random
import time
