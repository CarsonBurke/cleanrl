...
class Agent(nn.Module):
    def __init__(self, envs, args):
        ...
        # Learnable offset (replaces fixed LOG_STD_INIT=-2.0), init at same value
        self.log_std_offset = nn.Parameter(torch.tensor(LOG_STD_INIT))
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        writer.add_scalar("tbot/log_std_offset", agent.log_std_offset.item(), global_step)
