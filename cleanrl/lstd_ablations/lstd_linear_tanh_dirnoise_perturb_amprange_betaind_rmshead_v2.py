"""LSTD asymmetric PPO + compact ReLUSq/RMS independent Beta head.

This is the Beta-centered version of the v5 head ablation: keep the high
performing LSTD asymmetric PPO loop, but use compact v5-style ReLUSq/RMS
actor/critic heads with independent alpha/beta Beta parameters.
"""
import os
import random
import time
