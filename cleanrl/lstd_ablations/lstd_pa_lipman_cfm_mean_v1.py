"""LSTD perturb-amprange with a Lipman OT-CFM mean residual.
...
also adds the learned velocity at t=0 as a small deterministic residual to the
policy mean. PPO likelihoods remain exact because the residual is part of the
state-conditioned distribution parameters, not a likelihood-free sampler.
"""
import os
import random
import time
