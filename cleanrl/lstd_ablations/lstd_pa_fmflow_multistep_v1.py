"""LSTD perturb-amprange with a time-indexed exact action flow.

This is the flow-matching-style version of the coupling ablation: raw actions
are transported by several identity-initialized affine coupling steps, each
conditioned on a fixed path time. It approximates a small neural ODE while
remaining an exact normalizing flow for PPO log-ratios.
"""
import os
import random
import time
