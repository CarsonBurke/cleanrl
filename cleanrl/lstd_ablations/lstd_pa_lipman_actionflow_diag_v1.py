"""Beta-logit action flow with bounded-space Conditional Flow Matching.
...
train fixed-time coupling velocities along straight y-space paths to match
y1-y0 with normalized positive-advantage weighting.
"""
import os
import random
import time
