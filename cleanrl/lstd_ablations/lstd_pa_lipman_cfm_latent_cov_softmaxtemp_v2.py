"""LSTD perturb-amprange with latent-space OT-CFM and softer weights.
...
This variant keeps full covariance modulation but softens CFM weighting with a
modern softmax temperature.
"""
import os
import random
import time
...
class Args:
    ...
    cfm_weight_temp: float = 1.5
    """softmax temperature for advantage-weighted CFM targets"""
...
class Agent(nn.Module):
    def __init__(self, envs, args):
        ...
        self.cfm_weight_temp = float(args.cfm_weight_temp)
    ...
    def cfm_loss(self, x, actions, advantages, weight_clip):
        ...
        with torch.no_grad():
            ...
            weights = torch.softmax(adv / self.cfm_weight_temp, dim=0) * adv.numel()
