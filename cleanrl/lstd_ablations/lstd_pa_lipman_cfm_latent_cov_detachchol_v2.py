"""LSTD perturb-amprange with latent-space OT-CFM and detached recoloring.
...
This variant detaches the Cholesky used to recolor the CFM mean shift, testing
whether covariance/mean co-adaptation is useful or destabilizing.
"""
import os
import random
import time
...
class Agent(nn.Module):
    ...
    def _cfm_policy_terms(self, h, base_mean):
        ...
        chol = self._cov_cholesky(base_dist)
        mean_delta = torch.matmul(chol.detach(), latent_velocity.unsqueeze(-1)).squeeze(-1)
