"""Perturb + amprange with ReLUSq activations.

This keeps the high-performing low-rank Gaussian exploration, learned amplitude
range, basis perturbation, and asymmetric PPO update intact. The only intended
algorithmic change is replacing SiLU hidden activations with ReLU-squared.
"""
import os
import random
import time
