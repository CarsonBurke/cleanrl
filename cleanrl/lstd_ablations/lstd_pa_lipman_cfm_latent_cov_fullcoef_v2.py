"""LSTD perturb-amprange with full-strength latent CFM covariance.
...
This variant sets the covariance modulation coefficient to 1.0, allowing the
latent CFM field to scale low-rank amplitudes by up to exp(+-1) per direction.
"""
import os
import random
import time
