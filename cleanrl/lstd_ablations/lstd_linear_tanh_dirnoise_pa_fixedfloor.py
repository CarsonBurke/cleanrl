"""Perturb_amprange + fixed floor: replace learnable log_std_floor with fixed 1e-4.
Tests whether learnable diagonal is necessary when perturb stabilizes amprange.
fixedfloor + amprange alone regressed (6400), but perturb may change the dynamics.
"""
import os
import random
import time
