"""LSTD directional noise — biginit ablation.

Larger dir_head init (std=0.5 instead of 0.01) to give more diverse initial
per-direction amplitudes, letting the agent discover useful exploration
directions faster.
"""
import os
import random
...
class Agent(nn.Module):
    def __init__(self, envs, args):
        ...
        self.dir_head = layer_init(nn.Linear(hidden_dim, self.noise_rank), std=0.5)
