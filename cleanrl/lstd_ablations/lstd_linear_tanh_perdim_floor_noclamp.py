...
class Agent(nn.Module):
    ...
    def _get_action_std(self, h):
        ...
        # Learned per-element log-std with per-dim offset, no clamp
        log_std = self.log_std_param + self.log_std_offset
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        log_std_eff = agent.log_std_param + agent.log_std_offset
