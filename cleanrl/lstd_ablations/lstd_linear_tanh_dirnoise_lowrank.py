"""Ablation 2: Low noise rank instead of full rank.
Change: noise_rank = min(act_dim, 4) instead of act_dim.
Hypothesis: Full rank is just an expensive full covariance. Low rank forces the agent
to discover the most important exploration directions, providing better inductive bias
and cheaper computation.
"""
import os
import random
import time
...
class Agent(nn.Module):
    def __init__(self, envs, args):
        ...
        hidden_dim = 64
        # ABLATION: low rank instead of full rank
