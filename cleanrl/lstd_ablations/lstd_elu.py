...
LOG_STD_INIT = -2.55  # compensate for ELU+1 centering at 1.0 (3x larger latent²)
LOG_STD_MIN = -3.0
LOG_STD_MAX = -0.5
SDE_EPS = 1e-6
...
class Agent(nn.Module):
    ...
    def _get_action_std(self, h):
        ...
        # RMSNorm → ELU+1: non-negative, non-saturating, no sign-loss from squaring
        sde_latent = F.elu(self.sde_norm(sde_raw) / SDE_PRESCALE) + 1.0  # (batch, hidden_dim)
