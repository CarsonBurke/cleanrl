"""ReLU² LSTD latent CFM covariance with no softmax weights.
...
class Agent(nn.Module):
    ...
    def _actor_features(self, x):
        h = relusq(self.actor_norm1(self.actor_fc1(x)))
        h = relusq(self.actor_norm2(self.actor_fc2(h)))
        return h
    ...
    def _critic_features(self, x):
        h = relusq(self.critic_norm1(self.critic_fc1(x)))
        h = relusq(self.critic_norm2(self.critic_fc2(h)))
        return h
