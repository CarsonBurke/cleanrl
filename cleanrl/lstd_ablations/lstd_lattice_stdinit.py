...
class Agent(nn.Module):
    def __init__(self, envs, args):
        ...
        # Learned per-element noise magnitude: init directly at LOG_STD_INIT, no offset
        self.log_std_param = nn.Parameter(torch.full((hidden_dim, act_dim), LOG_STD_INIT))
    ...
    def _sde_latent_and_std(self, h):
        ...
        log_std = self.log_std_param.clamp(LOG_STD_MIN, LOG_STD_MAX)
