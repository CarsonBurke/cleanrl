"""Ablation: Normalize basis rows to unit norm (built on directamp).
Change: In _get_distribution, normalize noise_basis rows to unit length before use.
Prevents basis norm drift / scale entanglement with amplitude. Amplitude alone
controls magnitude of each exploration direction.
"""
import os
import random
import time
...
class Agent(nn.Module):
    ...
    def _get_distribution(self, h, action_mean):
        ...
        # ABLATION: normalize basis rows to unit norm
