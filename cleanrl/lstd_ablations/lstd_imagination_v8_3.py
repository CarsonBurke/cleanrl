"""Imagination v8.3 — v8.1 + Deeper RMSNorm+SiLU Encoder

Same as v8.1 (standard diagonal Gaussian actor, NOT LSTD) but with a deeper
RMSNorm+SiLU encoder instead of the shallow Tanh encoder:
- 3-layer encoder with RMSNorm+SiLU, no final activation (unbounded latent space)
...
The hypothesis: a deeper RMSNorm+SiLU encoder with unbounded latent space provides
better representations for the world model and policy than the shallow Tanh encoder.
"""
import os
import random
import time
