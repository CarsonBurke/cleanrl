"""LSTD loop + v5-style ReLUSq/RMS independent Beta head.

This ablates whether the v5 independent Beta policy was mainly missing LSTD's
asymmetric PPO update rather than LSTD's low-rank Gaussian exploration. It keeps
the strong perturb_amprange PPO loop and replaces the policy/value model with
compact ReLUSq/RMS heads and independent alpha/beta Beta parameters.
"""
import os
import random
import time
...
class Agent(nn.Module):
    def __init__(self, envs, args):
        ...
        hidden_dim = 64
        self.critic = ReluSqRMSHead(obs_dim, hidden_dim, 1, output_std=1.0)
        self.actor = ReluSqRMSHead(obs_dim, hidden_dim, 2 * act_dim, output_std=0.01)
