"""LSTD perturb-amprange with Lipman-style OT Conditional Flow Matching.
...
auxiliary only, so PPO likelihoods remain exactly those of the LSTD policy.
"""
import os
import random
import time
