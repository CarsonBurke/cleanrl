"""LSTD latent CFM no-softmax with clipped executed-action targets.
...
It keeps the unclipped Gaussian policy, but trains CFM on clipped action targets
to test whether the high out-of-bounds pressure in v2 is useful or a mismatch.
"""
import os
import random
import time
...
class Agent(nn.Module):
    ...
    def cfm_loss(self, x, actions, advantages, weight_clip):
        ...
        with torch.no_grad():
            ...
            residual = actions.detach().clamp(-1.0, 1.0) - base_mean
