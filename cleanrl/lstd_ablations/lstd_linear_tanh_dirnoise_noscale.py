"""Ablation 1: Remove mean_scale bottleneck.
Change: Remove learnable mean_scale=0.01 scalar, use std=0.01 layer init on actor_out instead.
Hypothesis: The scalar bottleneck constrains all action dims equally and has poor gradient
conditioning near zero. Standard small-init on the output layer achieves the same initial
...
class Agent(nn.Module):
    def __init__(self, envs, args):
        ...
        # ABLATION: std=0.01 layer init instead of mean_scale
    ...
    def get_action_and_value(self, x, action=None):
        ...
        # ABLATION: no mean_scale, just direct output
