...
class Agent(nn.Module):
    def __init__(self, envs, args):
        ...
        # Learned per-action noise floor: diffuse background exploration
        self.log_noise_floor = nn.Parameter(torch.full((act_dim,), -2.0))
    ...
    def _get_action_std(self, h):
        ...
        # Learned noise floor: targeted (L2) + diffuse background
        action_std = (action_var + self.log_noise_floor.exp().pow(2)).sqrt()
        return action_std
