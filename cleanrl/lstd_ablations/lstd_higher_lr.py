...
if __name__ == "__main__":
    ...
    optimizer = optim.Adam([
        {'params': [p for n, p in agent.named_parameters() if n != 'log_std_param'], 'lr': args.learning_rate},
        {'params': [agent.log_std_param], 'lr': args.learning_rate * 3},
    ], eps=1e-5)
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        if args.anneal_lr:
            ...
            optimizer.param_groups[1]["lr"] = lrnow * 3  # log_std_param at 3x
