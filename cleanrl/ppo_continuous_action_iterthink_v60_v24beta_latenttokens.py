# PPO + IterThink v60 (v24 Beta + recurrent latent tokens + role CLS reads). From v24.
#
...
#     observation-conditioned by x0, cross-attend to each prefix and concatenate
#     the resulting per-depth summaries.
#
