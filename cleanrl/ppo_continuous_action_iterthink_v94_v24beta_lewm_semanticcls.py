# PPO + IterThink v94 (v24 Beta + LeWM semantic CLS tokens). From v93.
#
...
class LeWMBackbone(nn.Module):
    def __init__(self, obs_dim, act_dim, args):
        ...
        self.outcome_norm = nn.RMSNorm(self.dim)
            ...
            for _ in range(args.lewm_update_epochs):
                ...
                for start in range(0, args.batch_size, wm_minibatch_size):
                    ...
                    for mtp_idx in range(mtp_len):
                        ...
                        pred = pred_mtp[:, :valid_horizon, mtp_idx, agent.world_model.obs_token_start :]
                        target = target_summaries[:, mtp_idx:, agent.world_model.obs_token_start :]
                    ...
                    if not latent_losses:
                        continue
                    wm_latent_loss = torch.stack(latent_losses).sum()
