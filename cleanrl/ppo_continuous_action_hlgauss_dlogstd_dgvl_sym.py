# HL-Gauss + Direct Log-Std + SYMMETRIC DG with Value-Loss Surprisal
#
# Ablation: symmetric gate using |advantage| instead of signed advantage.
# gate = sigmoid(|advantage| * value_loss / eta)
# This amplifies ALL high-advantage, high-value-error samples equally
# regardless of sign. Tests whether the asymmetric suppression of
# negatives in uncertain regions is load-bearing.
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                with torch.no_grad():
                    ...
                    delight = mb_advantages.abs() * vl_surprisal
