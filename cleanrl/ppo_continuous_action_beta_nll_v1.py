# PPO + Beta-NLL advantage weighting v1.
#
...
# - Weight PPO advantages by detached, peak-referenced Beta NLL:
...
class Args:
    ...
    beta_nll_weight_min: float = 0.25
    """minimum detached beta-NLL advantage weight"""
    beta_nll_weight_max: float = 4.0
...
if __name__ == "__main__":
    ...
    if not args.cuda or not torch.cuda.is_available():
        raise RuntimeError("ppo_continuous_action_beta_nll_v1 requires CUDA")
