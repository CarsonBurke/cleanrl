...
class Args:
    ...
    ret_ema_norm: bool = True        # master switch for advantage-scale normalization
    ...
    # DG-specific
    dg_use_gate: bool = False        # v15: gate OFF (no DG). Pure PPO score + KL trust region; this isolates
    #                                  DreamerV3's percentile normalization as a clean non-DG baseline.
