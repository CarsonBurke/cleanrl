# Pre-RMS SiTU-GLU PPO, v5: independent clipping with optional unclipped heads.
# Preserve v4 scalar value clipping, architecture, initialization and Adam.
# Excluding heads also excludes their gradients from each clipping norm;
# hypothesis: trunk-only budgets preserve direct policy/value readout adaptation.
import os
import random
import time
...
def main():
    ...
    try:
        ...
        writer.add_text(
            ...
            f"epochs={args.update_epochs}; clip_heads={args.clip_heads}; 1 minibatch; raw GAE",
        )
