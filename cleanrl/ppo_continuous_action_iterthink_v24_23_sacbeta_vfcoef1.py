# PPO + IterThink v24.23 (v24.5 SAC-Beta + vf_coef=1.0). From v24.5.
#
# Isolated critic-weight ablation: identical to v24.5 except the value loss
# coefficient is doubled from 0.5 to 1.0. This tests whether the consistently low
# explained variance is primarily critic update pressure/capacity allocation rather
# than the C51 target boundary bug.
#
