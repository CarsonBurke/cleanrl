...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        b_preference_direction = frozen_preference_direction.reshape(-1, sf_dim)
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                # The policy consumes the covector and vector trace directly. The sum is
                # their local directional derivative, not a decoded state value. Scale is
                # rollout-global and divide-only; no centering or coordinate whitening.
                mb_advantages = (
                    b_preference_direction[mb_inds] * b_vector_trace[mb_inds]
