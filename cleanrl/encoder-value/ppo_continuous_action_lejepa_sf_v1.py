# PPO + LeJEPA successor features v1: the critic stops predicting scalar returns.
# =====================================================================================
...
#   phi_t = [ e_t , a_t , a_t*a_t , 1 ]      reward features; dim = emb_dim + 2*act_dim + 1
...
# same boundary masks; only K goes from 511 bucket logits to emb_dim + 2*act_dim + 1 = 45
# SF dimensions (HalfCheetah: 32 + 12 + 1), and the loss from cross-entropy to masked MSE
...
class Agent(nn.Module):
    def __init__(self, envs, args):
        ...
        # bucket logits to K = emb_dim + 2*act_dim + 1 latent-occupancy dimensions.
        ...
        self.sf_dim = args.emb_dim + 2 * act_dim + 1  # [e, a, a*a, 1]
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        with torch.no_grad():
            ...
            phi = phi_features(emb_buf, actions)              # (T, B, sf_dim)
        ...
        writer.add_scalar("sf/lambda_std_act", sf_std[args.emb_dim : -1].mean().item(), global_step)
