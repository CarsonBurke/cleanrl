# PPO + compact reward-predictive successor features, v2.
#
...
# anchoring, action-conditioned one-step closure, and old-frame TD0 targets.
import os
import random
import time
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for _ in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                if mb_valid.any():
                    sf_loss = F.mse_loss(new_psi[mb_valid], b_psi_targets[mb_inds][mb_valid])
                else:
                ...
                critic_loss = (
                    args.vf_coef * args.sf_loss_coef * sf_loss
        ...
        writer.add_scalar("losses/vector_sf", acc["sf"] / critic_n, global_step)
