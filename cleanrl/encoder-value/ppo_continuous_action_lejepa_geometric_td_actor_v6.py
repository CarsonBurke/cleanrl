# PPO + LeJEPA normalized geometric TD actor, v6.
#
...
# The actor accumulates 16 vector Bellman innovations, contracts with the lagged reward
# covector, divides by (1-gamma), and adds the exact immediate reward-residual trace.
# Sixteen is only the estimator unroll; M retains the complete geometric horizon.
# After reward contraction this telescopes to an ordinary fixed-16 actor-critic
# advantage: embeddings supply its learned full-horizon baseline, not a new reward
# gradient.
