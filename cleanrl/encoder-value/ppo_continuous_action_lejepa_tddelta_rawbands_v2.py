# PPO + LeJEPA TDDelta raw-bands v2: stationary state-value coordinates.
#
...
# bands. Fixed band-width factors derived from the geometric horizon grid condition only
# its loss; there are no moving value-target normalization statistics.
#
