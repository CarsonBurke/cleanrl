# Fixed-TD GAE Advantage Critic PPO v5
#
# Ablation hypothesis:
# - Keep standard V(s)-based TD(lambda)/GAE for the long-horizon trajectory signal.
# - Train A(s, a) without GAE distillation as a neural predictor of the fixed
#   rollout TD residual: A(s,a) ~= stopgrad(r + gamma V_old(s') - V_old(s)).
...
class Args:
    ...
    current_advantage_mix: float = 0.25
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for pretrain_epoch in range(args.advantage_pretrain_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                adv_loss = 0.5 * ((newadv - b_deltas[mb_inds]) ** 2).mean()
