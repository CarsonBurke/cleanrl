# GAE-Pure Advantage Critic PPO v6
#
# Ablation hypothesis:
...
# - Use only detached predicted A(s,a) in PPO's clipped policy loss. Raw GAE is
#   supervision for the advantage critic, never a direct policy weight.
...
#
# This isolates whether the critic can learn a smoother action-conditioned
# advantage estimator from GAE without relying on raw GAE in the actor update.
import os
import random
import time
