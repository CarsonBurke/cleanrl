# HOPSD v36 — additive privilege (pooled + attention) with a reliance cap.
# =====================================================================================
...
class Args:
    ...
    # TEACHER TRAINING replaces the summary with null_summary (pooled kept in hybrid), capping how
    # much the teacher's conditional can lean on the attention channel. No dropout at query time.
    phi_dropout: float = 0.25
