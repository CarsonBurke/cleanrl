# PPO + IterThink v179 outcomejepatokens-detachedprobes-jointsigreg-pretemporalwm-beliefonly-ppoadvnorm-actor1-critic10-cliphi-criticsigma075-dreamer3bucket-hlgauss-wmloss1024-cudagraph-contdisc-k6.
#
        ...
        for _ in range(args.lewm_update_epochs):
            ...
            for start in range(0, args.batch_size, wm_minibatch_size):
                ...
                sigreg_A = sigreg.sample_projection(
                    # v179: joint SIGReg projects the flattened FULL 19-token frame vector.
