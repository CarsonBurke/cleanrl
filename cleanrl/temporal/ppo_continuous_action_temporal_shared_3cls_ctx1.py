# PPO temporal shared-backbone ablation with history length 1.
#
# This isolates whether the gain, if any, comes from the multi-CLS readout or
# from giving the transformer actual temporal context.
import os
import random
import time
