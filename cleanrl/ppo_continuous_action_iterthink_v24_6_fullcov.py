# PPO + IterThink v24.6 (FULL-COVARIANCE TANH NORMAL). From v24.
#
...
#
# v24.6 keeps v24's PPO, critic, advantage shaping, and native-sample replay, but
# makes the default actor a state-dependent full-covariance tanh Normal:
#     z ~ N(mu(s), L(s)L(s)^T), action = tanh(z)
#     log_prob = log N(z; mu, LL^T) - sum_i log |d tanh(z_i)/dz_i|
# The Cholesky diagonal is a SAC-style bounded log_std head initialized at std=1.
...
class Args:
    ...
    # v24.6: action distribution. "fullcov" (state-dependent full-cov tanh Normal)
    ...
    fullcov_log_std_init: float = 0.0
    fullcov_offdiag_scale: float = 0.5
...
class Agent(nn.Module):
    def __init__(self, envs, args):
        ...
        # v24.6: full-covariance tanh Normal default, with v24 beta/diagonal controls.
