...
# Hidden trunk is SiTU-GLU (sTiGLU): SiTUGLUBranch blocks replace each
# Linear+LeakyReluSq stage, two stacked per trunk (tpo v5 layout; per-block
# output-scale matched to the replaced stage).
import os
import random
import time
...
def main():
    ...
    try:
        ...
        writer.add_text("policy", "Beta host actor; 32x LR; 1 minibatch; SiTU-GLU trunk; no advantage normalization")
