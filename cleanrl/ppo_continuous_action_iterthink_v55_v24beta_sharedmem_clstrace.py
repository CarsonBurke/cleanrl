# PPO + IterThink v55 (v24 Beta + shared-memory loop bank + role CLS traces). From v24.
#
...
#     the role CLS tokens query each loop-prefix ledger for readout traces, but
#     are never appended to the future memory ledger.
