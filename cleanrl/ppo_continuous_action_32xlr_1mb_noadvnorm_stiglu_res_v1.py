...
# Hidden trunk is residual SiTU-GLU (sTiGLU): in_proj -> two gated SiTU blocks
# with per-block residuals + a U-net long skip (scalar gates init ~0.18, no
# normalization). Residuals keep trunk outputs O(1); see stiglu_res_v1 header.
import os
import random
import time
...
def main():
    ...
    try:
        ...
        writer.add_text("policy", "Beta host actor; 32x LR; 1 minibatch; residual SiTU-GLU trunk; no advantage normalization")
