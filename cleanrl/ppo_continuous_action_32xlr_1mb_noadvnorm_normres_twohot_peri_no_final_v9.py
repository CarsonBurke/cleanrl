# Peri-RMS two-hot PPO, v9: no final norm, no gradient clipping, one epoch.
# Matched scalar v8 comparison uses normalized rewards and the same optimizer.
# Preserve raw-space labels/expectation on 255 symexp atoms, zero bin head,
# branch input/output RMS, residual gates and 1/sqrt(width) readout scaling.
# Hypothesis: distributional critic geometry helps with one update per rollout.
import os
import random
import time
