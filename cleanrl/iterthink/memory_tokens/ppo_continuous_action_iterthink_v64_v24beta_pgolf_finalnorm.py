# PPO + IterThink v64 (v24 Beta + parameter-golf residual mixing + final norm). From v24.
#
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                actor_trunk_raw_gn = 0.0
                actor_head_raw_gn = 0.0
                critic_trunk_raw_gn = 0.0
                critic_head_raw_gn = 0.0
                ...
                if args.separate_grad_clip:
                    ...
                    critic_trunk_raw_gn = grad_norm_value(critic_trunk.parameters())
                    critic_head_raw_gn = grad_norm_value(agent.critic_head.parameters())
                    ...
                    actor_trunk_raw_gn = grad_norm_value(actor_trunk.parameters())
                    actor_head_raw_gn = grad_norm_value(agent.actor_head_parameters())
                    ...
                    optimizer.zero_grad()
                    loss.backward()
                    trunk = agent.trunk if agent.share_backbone else agent.actor_trunk
                    actor_trunk_raw_gn = critic_trunk_raw_gn = grad_norm_value(trunk.parameters())
                    actor_head_raw_gn = grad_norm_value(agent.actor_head_parameters())
                    critic_head_raw_gn = grad_norm_value(agent.critic_head.parameters())
        ...
        writer.add_scalar("debug/actor_trunk_grad_norm_raw", actor_trunk_raw_gn, global_step)
        writer.add_scalar("debug/actor_head_grad_norm_raw", actor_head_raw_gn, global_step)
        writer.add_scalar("debug/critic_trunk_grad_norm_raw", critic_trunk_raw_gn, global_step)
        writer.add_scalar("debug/critic_head_grad_norm_raw", critic_head_raw_gn, global_step)
