# PPO + IterThink v70 (v56 + wider actor/critic readout). From v24.
#
...
#   - Actor and critic use separate read tokens only after the recurrent loop.
#     v70 widens this PMA-style readout from one token to four tokens per role to
#     test whether v56's late gap comes from compressing v24's widened ledger too
#     aggressively before the final projection.
...
class ThinkTrunk(nn.Module):
    def __init__(self, in_dim, H, K, args):
        ...
        self.num_read_tokens = args.read_tokens
