# PPO + IterThink v67 (v56 + late Beta entropy floor). From v24.
#
...
#   - v67 keeps the v56 architecture unchanged. The 8M v56 rerun learns faster
#     than v24 but over-sharpens late (entropy ~-11.6, concentration ~50), causing
#     final variance/regression. Add a weak Beta-only entropy floor that is inactive
#     until the policy becomes more deterministic than the v24/v63 final regime.
#
...
class Args:
    ...
    ent_coef: float = 0.0
    beta_entropy_floor_per_dim: float = -1.75  # HalfCheetah act_dim=6 => floor -10.5; inactive until late v56 oversharpening
    beta_entropy_floor_coef: float = 0.005
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                if args.actor_dist == "beta" and args.beta_entropy_floor_coef > 0.0:
                    ...
                    beta_entropy_floor_loss = (
                        args.beta_entropy_floor_coef * (beta_entropy_floor - entropy_loss).clamp_min(0.0).pow(2)
                    )
                else:
                    beta_entropy_floor = 0.0
        ...
        writer.add_scalar("losses/beta_entropy_floor_loss", beta_entropy_floor_loss.item(), global_step)
