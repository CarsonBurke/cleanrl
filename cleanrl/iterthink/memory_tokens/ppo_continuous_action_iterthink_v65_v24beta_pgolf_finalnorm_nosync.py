# PPO + IterThink v65 (v24 Beta + parameter-golf final norm + no-sync debug). From v24.
#
...
class ThinkTrunk(nn.Module):
    def __init__(self, in_dim, H, K, args):
        ...
        self.actor_feat_norm = nn.RMSNorm(H, elementwise_affine=False)
        self.critic_feat_norm = nn.RMSNorm(H, elementwise_affine=False)
