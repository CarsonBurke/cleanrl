...
# remains calibrated. With auto-entropy off, the PPO update is unchanged; v24.3 changes
...
#
#   actor_dist="beta"  (DEFAULT, SAC-Beta shifted log-concentration path):
#       unimodal Beta, matching ../sac-beta:
...
class Args:
    ...
    # v24.3: action distribution. "beta" (SAC-Beta shifted log concentration) | "gaussian"
...
class Agent(nn.Module):
    def __init__(self, envs, args):
        ...
        # v24.3: SAC-Beta shifted-log-concentration default plus SAC-style Gaussian control path.
