...
# remains calibrated. With the default beta distribution and auto-entropy off, behavior
# remains byte-identical to the v24 base.
#
...
# an explicit std=1 initialization target.
...
class Args:
    ...
    # v24.2: action distribution. "beta" (unimodal, dreamer4 default) | "gaussian"
...
class Agent(nn.Module):
    def __init__(self, envs, args):
        ...
        # v24.2: beta default plus SAC-style tanh-Gaussian log_std control path.
