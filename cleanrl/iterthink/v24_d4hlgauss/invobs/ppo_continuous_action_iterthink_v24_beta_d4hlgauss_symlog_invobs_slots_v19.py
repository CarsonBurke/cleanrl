# PPO + IterThink v24 beta d4-HL-Gauss symlog + inverted-attention slot transformer v19.
#
...
class ThinkTrunk(nn.Module):
    ...
    def forward_actor(self, x):
        if self.unified:
            return self._readout(self.stack.actor_forward(self.encode_tokens(x)))
    ...
    def forward(self, x):
        ...
        if self.unified:
            ...
            return self._readout(sa), self._readout(sc)
