# PPO + IterThink v24 beta d4-HL-Gauss symlog + Dynamic Sparse Recurrent Graph (DSRG) v6.
#
# WHAT CHANGES vs DSRG v5: the ROUTING PRIMITIVE. v5's gates were independent per-edge
