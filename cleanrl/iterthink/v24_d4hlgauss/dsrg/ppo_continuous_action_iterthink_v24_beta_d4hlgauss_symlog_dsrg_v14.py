# PPO + IterThink v24 beta d4-HL-Gauss symlog + Dynamic Sparse Recurrent Graph (DSRG) v14.
#
# WHAT CHANGES vs DSRG v8: a DIRECT obs->actor-feature residual (a single linear skip).
