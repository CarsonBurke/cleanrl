# PPO + IterThink v24 beta d4-HL-Gauss symlog raw-return critic nGPT-justnorm v3.
#
...
# per-channel eigen learning rates initialized at max strength (1.0). v3 combines
# the dense and MoE branches into one normalized residual target so max-strength
# initialization does not let the later branch overwrite the earlier branch's
# gradient. Observation handling remains the rawret env-normalized/clipped
