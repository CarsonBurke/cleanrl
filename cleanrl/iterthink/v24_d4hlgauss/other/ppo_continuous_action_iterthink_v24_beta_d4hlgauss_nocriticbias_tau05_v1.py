# PPO + IterThink v24 beta d4-HL-Gauss no-critic-bias tau05 v1.
#
...
# benefits from an unbiased initial categorical head. This version narrows the
# HL-Gauss target smoothing to sigma/bin_width = 0.5 instead of Dreamer4's
# default 2.0.
#
# Base: ppo_continuous_action_iterthink_v24_beta_d4hlgauss_nocriticbias_v1.py.
# Only intended algorithmic change from that file: value_sigma_to_bin_ratio=0.5.
#
