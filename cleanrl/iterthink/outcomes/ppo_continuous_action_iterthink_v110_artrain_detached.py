            ...
            for _ in range(args.lewm_update_epochs):
                ...
                for start in range(0, args.batch_size, wm_minibatch_size):
                    ...
                    for h in range(horizon):
                        ...
                        ar_pred_summaries.append(ar_next_summary)
                    ...
                    # FULL token set: the fed-back obs tokens and the semantic outcome
                    # tokens (embeddings read by decode_outcomes; logits don't need
                    # SIGReg, their embeddings do) are treated the same. Attached
                    # tensors (pre-detach), scaled under lewm_ar_loss_coef.
