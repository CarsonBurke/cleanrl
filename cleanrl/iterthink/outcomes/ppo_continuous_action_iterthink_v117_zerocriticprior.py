...
#   - Critic and reward scalar consumption use HLGaussSupport.to_expected_scalar,
#     the explicit E[symexp(bin)] decode. HLGaussSupport.to_scalar remains
#     symexp(E[z]) for callers that deliberately want coordinate-space means.
#
# Hypothesis:
