# PPO + IterThink v153 critic-sigma05-k6 (v152 + sharper critic HL-Gauss target).
#
# Key change from v152:
#   - Set the critic/value HL-Gauss target projection sigma to 0.5 bins instead
#     of 2.0. Reward HL-Gauss already uses 0.5; this sharpens the critic target
#     and reduces excess value-target smoothing.
#
# -----------------------------------------------------------------------------
# Previous header:
...
class Args:
    ...
    value_sigma_to_bin_ratio: float = 0.5  # HL-Gauss projection sigma in bins
