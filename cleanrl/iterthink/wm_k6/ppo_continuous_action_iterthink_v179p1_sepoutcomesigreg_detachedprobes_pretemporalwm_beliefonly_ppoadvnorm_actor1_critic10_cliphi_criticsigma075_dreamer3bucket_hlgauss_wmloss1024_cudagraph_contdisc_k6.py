# PPO + IterThink v179.1 sepoutcomesigreg-detachedprobes-pretemporalwm-beliefonly-ppoadvnorm-actor1-critic10-cliphi-criticsigma075-dreamer3bucket-hlgauss-wmloss1024-cudagraph-contdisc-k6.
#
...
class LeWMBackbone(nn.Module):
    ...
    def decode_belief_outcomes(self, belief, detach_belief=True):
        ...
        reward_feat = unit_norm(belief[..., self.reward_token_idx, :])
        reward_logits = self.reward_token_unproj(reward_feat)
        continuation_logits = self.continuation_token_unproj(belief[..., self.continuation_token_idx, :]).squeeze(-1)
