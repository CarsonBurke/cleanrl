# PPO + IterThink v188 plainflow-dit-k6 (ablate shortcut -> PLAIN conditional flow matching).
#
...
class Args:
    ...
    lewm_flow_dream_temperature: float = 1.0  # dream-loop generation: 0 => one-shot conditional mean, >0 => z0 ~ N(0,I)*tau + 8-step Euler
...
class FlowMatchingHead(nn.Module):
    """v188: 3-block AdaLN-zero DiT flow head (MLP-only, per-token), x-parameterization,
