...
#     real bite. ("replacing the ratio-clip heuristic" was the original wording and is
#     FALSIFIED -- see v3's header: the clip bounds the per-sample IS ratio, which a mean
#     parametric KL structurally cannot. The two are complementary.) The faithful
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                kl_coef = kl_coef_faithful + args.kl_beta
