# PPO + IterThink v24 Beta + d3bucket MTP + PPO-ADVNORM(batch) + v10_fullbatch + DG-ABS, NO NEXTLAT (v2).
# v2 delta vs DG-ABS: nextlat=False. Tests whether the abs 3x slowdown vs the
# v10 base is aux-trunk capture (recovers baseline speed with aux off) or gate
# neg-erasure (stays slow: pos_mass->0.99 deletes the downgoer). Also removes
# the aux-driven head-death channel suspected in the DG-REL freeze. DG-ABS gate
# unchanged; `--no-dg` would be bit-identical to the no-aux v10 base.
# =====================================================================================
...
class Args:
    ...
    nextlat: bool = False   # v2: aux OFF (discriminates aux-capture vs gate neg-erasure)
