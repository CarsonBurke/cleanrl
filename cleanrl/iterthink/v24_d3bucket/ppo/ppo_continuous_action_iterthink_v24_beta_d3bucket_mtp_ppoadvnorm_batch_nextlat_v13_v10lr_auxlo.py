# PPO + IterThink v24 Beta + d3bucket MTP + PPO-ADVNORM(batch) + NEXTLAT v13_v10lr_auxlo.
# =====================================================================================
# V10 LRs + AUX SPLIT: v11's actor 1e-2 was insane (killed on sight); v12
# (1e-2 at 128 envs) confirmed bigger-steps-at-1-epoch is the wrong direction
# here (1063 @1M). So: back to v10's sane actor 3e-3 / critic 1e-3, KEEPING
# v11's aux-predictor group at 3e-4 (it worked mechanically: actor aux grad
# norm 135 vs 2306, no blowups). Isolates whether aux noise was the waviness
# source, at the known-good 64x39 scale. Deltas from v11: actor_lr 1e-2 ->
# 3e-3 only. (v11 context below: v10 left the actor frozen, aux streams noisy.)
...
class Args:
    ...
    actor_lr: float = 3e-3          # v13: v10 value (v11's 1e-2 was insane)
