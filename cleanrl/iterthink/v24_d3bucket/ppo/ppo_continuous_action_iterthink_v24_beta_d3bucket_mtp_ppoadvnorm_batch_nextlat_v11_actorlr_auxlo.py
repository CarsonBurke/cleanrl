# PPO + IterThink v24 Beta + d3bucket MTP + PPO-ADVNORM(batch) + NEXTLAT v11_actorlr_auxlo.
# =====================================================================================
# LR REBALANCE: v10 (64x39, 1 update/rollout) left the actor frozen (approx_kl
# max 1.2e-7, clipfrac 0) while aux streams injected noise (actor aux grad norm
# hit 4e5 early; critic aux KL hit inf). Deltas from v10:
