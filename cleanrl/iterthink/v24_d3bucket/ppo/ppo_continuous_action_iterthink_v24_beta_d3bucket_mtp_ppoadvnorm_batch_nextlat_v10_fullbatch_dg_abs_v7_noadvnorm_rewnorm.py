# PPO + IterThink v24 Beta + d3bucket MTP + NEXTLAT v10_fullbatch + DG-ABS, NO-ADVNORM + REWNORM (v7).
# =====================================================================================
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        # DG-ABS (sole delta): sign-asymmetric ABSOLUTE-density rareness gating
        # BEFORE batch norm_adv. q = 1 - clip(exp(true log-density), 0, 1), no
        # batch comparison: the gate quiets as the policy sharpens instead of
        # forcing contrast. The buffered logprob drops the constant rescale
        # Jacobian (cancels in the PPO ratio) so beta restores it from the
        # action bounds; gaussian stored logprob already includes tanh Jacobian.
        if args.dg:
