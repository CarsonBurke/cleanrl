...
class Agent(nn.Module):
    def __init__(self, envs, args):
        ...
        if not self.detach_world_model_from_agent:
            raise ValueError("v197 requires a strictly detached world-model/agent interface")
...
if __name__ == "__main__":
    ...
    assert args.detach_world_model_from_agent, "v197 requires PPO to be detached from the WM"
    ...
    assert args.share_backbone, "v197 preserves v145's shared actor/critic trunk"
    ...
    assert shared_trunk_params, "v197 expects a genuinely shared actor/critic trunk"
