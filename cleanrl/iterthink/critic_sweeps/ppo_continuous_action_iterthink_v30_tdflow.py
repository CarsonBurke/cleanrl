# PPO + IterThink v30 (TD-FLOW CRITIC — fixed velocity-net architecture). From v29.
#
...
class Agent(nn.Module):
    ...
    def flow_value(self, x, n_samples, steps):
        ...
        cond_rep = x.repeat_interleave(n_samples, dim=0)   # condition on the RAW observation
