# PPO + IterThink + DISCRETIZED-ACTION DIFFUSIONBLOCKS POLICY v1.
# =====================================================================================
...
class DiscActorHead(nn.Module):
    ...
    def __init__(self, H, act_dim, args):
        ...
        # ---- frozen ordered Fourier codebook over the bin centers
        ...
        self.register_buffer("codebook", F.normalize(e, dim=-1) * args.dblock_latent_norm)
    ...
    def latent_of(self, q):
        """(N,A,M) distribution over bins -> (N,A*d) latent. LINEAR in q."""
        return (q @ self.codebook).flatten(-2)
