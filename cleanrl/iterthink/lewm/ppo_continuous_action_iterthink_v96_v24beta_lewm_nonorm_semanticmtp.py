# PPO + IterThink v96 (v24 Beta + no final latent norms). From v95.
#
...
class Agent(nn.Module):
    ...
    def _obs_with_wm_residual(self, obs, agent_input):
        ...
        wm_residual = self.wm_adapter_scale * self.wm_to_obs(agent_input)
    ...
    def actor_parameters(self):
        ...
        adapter = list(self.wm_to_obs.parameters())
