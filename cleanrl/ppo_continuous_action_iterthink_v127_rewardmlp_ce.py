# PPO + IterThink v127 rewardmlp-ce (v121 + post-action ReLU^2 reward readout).
#
...
#   - Keep v120/v121's symlog HL-Gauss CE reward objective. This isolates the
#     useful-looking v126 post-action capacity from v126's broken CRPS reward
#     training.
#
# Hypothesis:
#   v126 recovered strongly despite collapsed dream reward scale, suggesting the
#   post-action ReLU^2 reward readout may improve representation/credit while
#   the CRPS objective was the failure. Restoring CE should recover v120's reward
#   calibration while retaining the action-sensitive readout.
#
# -----------------------------------------------------------------------------
# Previous header:
