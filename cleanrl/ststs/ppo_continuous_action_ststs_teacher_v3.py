...
DISTILL_COEF = 0.1          # small distillation — teacher as gentle nudge
DISTILL_WARMUP_ITERS = 20   # longer warmup so teacher has time to learn before influencing actor
PG_COEF = 1.0               # full PG always — distillation is supplementary
